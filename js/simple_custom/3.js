var t, e, i, s, n = {
        640: (t, e, i) => {
            ...
            class ColorConverters {
                ...
                static CMYK_RGB([t, e, i, s]) {
                    return ["RGB", 1 - Math.min(1, t + s), 1 - Math.min(1, i + s), 1 - Math.min(1,
                        e + s)]
                }
                static CMYK_rgb([t, e, i, s]) {
                    return [scaleAndClamp(1 - Math.min(1, t + s)), scaleAndClamp(1 - Math.min(1, i +
                        s)), scaleAndClamp(1 - Math.min(1, e + s))]
                }
                static CMYK_HTML(t) {
                            ...
                            switch (t.data.fieldType) {
                                ...
                                case "Btn":
                                    return t.data.radioButton ?
                                        new RadioButtonWidgetAnnotationElement(t) : t.data
                                        .checkBox ? new CheckboxWidgetAnnotationElement(t) :
            ...
            class AnnotationElement {
                ...
                _createContainer(t) {
                    ...
                    const {
                        width: c,
                        height: u
                    } = getRectDims(e.rect), p = s.Util.normalizeRect([e.rect[0], i.view[3] - e
                        .rect[1] + i.view[1], e.rect[2], i.view[3] - e.rect[3] + i.view[1]
                    ]);
                    if (!t && e.borderStyle.width > 0) {
                        ...
                        if (t > 0 || i > 0) {
                            const e =
                                `calc(${t}px * var(--scale-factor)) / calc(${i}px * var(--scale-factor))`;
                            a.style.borderRadius = e
                        } else if (this instanceof RadioButtonWidgetAnnotationElement) {
                            const t =
                                `calc(${c}px * var(--scale-factor)) / calc(${u}px * var(--scale-factor))`;
            ...
            class LinkAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    if (t.url) {
                        ...
                        if (t.actions && (t.actions.Action || t.actions["Mouse Up"] || t.actions[
                                "Mouse Down"]) && this.enableScripting && this.hasJSActions) {
                ...
                _bindResetFormAction(t, e) {
                    ...
                    if (this._fieldObjects) t.onclick = () => {
                        ...
                        for (const t of r) {
                            ...
                            i && (l.has(i) ? i.dispatchEvent(new Event("resetform")) : (0, s
                                .warn)(
                                `_bindResetFormAction - element not allowed: ${e}`))
                        }
                        this.enableScripting && this.linkService.eventBus ? .dispatch(
                            "dispatcheventinsandbox", {
                                source: this,
                                detail: {
                                    id: "app",
            ...
            class TextAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    t.src = this.imageResourcesPath + "annotation-" + this.data.name.toLowerCase() +
                        ".svg";
            ...
            class WidgetAnnotationElement extends AnnotationElement {
                ...
                showElementAndHideCanvas(t) {
                    if (this.data.hasOwnCanvas) {
                        "CANVAS" === t.previousSibling ? .nodeName && (t.previousSibling.hidden = !
                            0);
                        t.hidden = !1
                    }
                }
                ...
                _setEventListener(t, e, i, s, n) {
                    i.includes("mouse") ? t.addEventListener(i, (t => {
                        ...
                        n && this.linkService.eventBus ? .dispatch(
                            "dispatcheventinsandbox", {
                                source: this,
                                detail: {
                                    id: this.data.id,
                ...
                _setEventListeners(t, e, i, s) {
                    for (const [n, a] of i)
                        if ("Action" === a || this.data.actions ? . [a]) {
                            ...
                            "Focus" !== a || this.data.actions ? .Blur ? "Blur" !== a || this.data
                                .actions ? .Focus || this._setEventListener(t, e, "focus", "Focus",
                                    null) : this._setEventListener(t, e, "blur", "Blur", null)
                        }
                }
                _setBackgroundColor(t) {
                    const e = this.data.backgroundColor || null;
                    t.style.backgroundColor = null === e ? "transparent" : s.Util.makeHexColor(e[0],
                        e[1], e[2])
                }
                _setTextStyle(t) {
            ...
            class TextWidgetAnnotationElement extends WidgetAnnotationElement {
                constructor(t) {
                    super(t, {
                        isRenderable: t.renderForms || t.data.hasOwnCanvas || !t.data
                            .hasAppearance && !!t.data.fieldValue
                    })
                }
                ...
                render() {
                    ...
                    if (this.renderForms) {
                        ...
                        i.addEventListener("input", (s => {
                            ...
                            this.setPropertyOnSiblings(i, "value", s.target.value,
                                "value");
                        ...
                        if (this.enableScripting && this.hasJSActions) {
                            ...
                            i.addEventListener("updatefromsandbox", (i => {
                                ...
                                const s = {
                                    ...
                                    formattedValue(i) {
                                        ...
                                        h.formattedValue = s;
                                        null != s && i.target !== document
                                            .activeElement && (i.target.value = s);
                                        t.setValue(e, {
                                            formattedValue: s
                                        })
                                    },
                                    selRange(t) {
                                        t.target.setSelectionRange(...t.detail
                                            .selRange)
                                    },
                                    charLimit: i => {
                                        const {
                            ...
                            i.addEventListener("keydown", (t => {
                                h.commitKey = 1;
                                let i = -1;
                                "Escape" === t.key ? i = 0 : "Enter" !== t.key || this
                                    .data.multiLine ? "Tab" === t.key && (h.commitKey =
                                        3) : i = 2;
                                if (-1 === i) return;
                                const {
                                    value: s
                            ...
                            i.addEventListener("blur", (t => {
                                ...
                                h.userValue = i;
                                h.lastCommittedValue !== i && this.linkService
                            ...
                            this.data.actions ? .Keystroke && i.addEventListener("beforeinput", (
                                t => {
            ...
            class RadioButtonWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    ...
                    n.addEventListener("change", (e => {
                        ...
                        for (const e of this._getElementsByName(s, i)) t.setValue(e
                            .id, {
                                value: !1
                            });
                        t.setValue(i, {
                        ...
                        n.addEventListener("updatefromsandbox", (e => {
                            const n = {
                                value: e => {
                                    ...
                                    for (const s of this._getElementsByName(e
                                            .target.name)) {
                                        const e = n && s.id === i;
            ...
            class ChoiceWidgetAnnotationElement extends WidgetAnnotationElement {
                ...
                render() {
                    ...
                    const getValue = t => {
                        ...
                        return n ? Array.prototype.filter.call(i, (t => t.selected)).map((t =>
                            t[e])) : -1 === i.selectedIndex ? null : i[i.selectedIndex][e]
                    };
                    let r = getValue(!1);
                    const getItems = t => {
                        ...
                        s.addEventListener("updatefromsandbox", (i => {
                            const n = {
                                value(i) {
                                    ...
                                    for (const t of s.options) t.selected = o.has(t
                                        .value);
                                    t.setValue(e, {
                                        value: getValue(!0)
                                    });
                                ...
                                remove(i) {
                                    ...
                                    s.remove(a);
                                    if (n.length > 0) {
                                        -1 === Array.prototype.findIndex.call(n, (
                                            t => t.selected)) && (n[0]
                                            .selected = !0)
                                    }
                                    t.setValue(e, {
                                ...
                                insert(i) {
                                    const {
                                        ...
                                        displayValue: a,
                                        exportValue: o
                                    } = i.detail.insert, l = s.children[n], h =
                                ...
                                items(i) {
                                    ...
                                    s.options.length > 0 && (s.options[0]
                                        .selected = !0);
                                    t.setValue(e, {
                                        value: getValue(!0),
                                        items: getItems(i)
                                ...
                                indices(i) {
                                    ...
                                    for (const t of i.target.options) t.selected = s
                                        .has(t.index);
                                    t.setValue(e, {
                                        value: getValue(!0)
                                    });
            ...
            class PopupAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    this.container.setAttribute("aria-controls", e.map((t =>
                        `${s.AnnotationPrefix}${t}`)).join(","));
                    return this.container
                }
            }
            class PopupElement {
                ...
                render() {
                    ...
                    } = this.#b, o = this.#y = document.createElement("div");
                    o.className = "popup";
                    if (this.#u) {
                        ...
                        if (CSS.supports("background-color", "color-mix(in srgb, red 30%, white)"))
                            ...
                            const t = .7;
                            o.style.backgroundColor = s.Util.makeHexColor(...this.#u.map((e => Math
                                .floor(t * (255 - e) + e))))
                        }
                    }
                    ...
                    for (const t of this.#f)
                        if (!p || null !== s.Util.intersect(t.data.rect, p)) {
                            ...
                            u = !0;
                            break
                        } const g = s.Util.normalizeRect([p[0], t[3] - p[1] + t[1], p[2], t[3] - p[
                            3] + t[1]]),
                        m = u ? p[2] - p[0] + 5 : 0,
                        f = g[0] + m,
                        b = g[1],
                ...
                a(t) {
                    t.altKey || t.shiftKey || t.ctrlKey || t.metaKey || ("Enter" === t.key ||
                        "Escape" === t.key && this.#v) && this.#c()
                }#
                c() {
                    this.#v = !this.#v;
                    if (this.#v) {
            ...
            class FileAttachmentAnnotationElement extends AnnotationElement {
                ...
                render() {
                    ...
                    if (e.hasAppearance || 0 === e.fillAlpha) i = document.createElement("div");
                        ...
                        e.fillAlpha && e.fillAlpha < 1 && (i.style =
                            `filter: opacity(${Math.round(100*e.fillAlpha)}%);`)
                    }
                    i.addEventListener("dblclick", this.#P.bind(this));
                    this.#F = i;
                    const {
                        isMac: n
                    } = s.FeatureTest.platform;
                    t.addEventListener("keydown", (t => {
                        "Enter" === t.key && (n ? t.metaKey : t.ctrlKey) && this.#P()
                    }));
                    !e.popupRef && this.hasPopupData ? this._createPopup() : i.classList.add(
                        "popupTriggerArea");
                    t.append(i);
                    return t
                }
        ...
        780: (t, e, i) => {
            ...
            class AnnotationStorage {
                ...
                setValue(t, e) {
                    ...
                    s && this.#U();
                    e instanceof n.AnnotationEditor && "function" == typeof this
                        .onAnnotationEditor && this.onAnnotationEditor(e.constructor._type)
                }
                has(t) {
                    return this.#N.has(t)
                }
            ...
            i.a(t, (async (t, s) => {
                try {
                    ...
                    const y = 65536,
                        ...
                        w = n.isNodeJS ? l.NodeCMapReaderFactory : r
                        .DOMCMapReaderFactory,
                        S = n.isNodeJS ? l.NodeFilterFactory : r.DOMFilterFactory,
                        C = n.isNodeJS ? l.NodeStandardFontDataFactory : r
                    ...
                    function getDocument(t) {
                        ...
                        if ("object" != typeof t) throw new Error(
                            "Invalid parameter in getDocument, need parameter object."
                        );
                        if (!t.url && !t.data && !t.range) throw new Error(
                        ...
                        const e = new PDFDocumentLoadingTask,
                            ...
                            h = t.password ? ? null,
                            u = t.range instanceof PDFDataRangeTransport ? t.range :
                            null,
                            p = Number.isInteger(t.rangeChunkSize) && t.rangeChunkSize >
                            0 ? t.rangeChunkSize : y;
                        let A = t.worker instanceof PDFWorker ? t.worker : null;
                        const v = t.verbosity,
                            _ = "string" != typeof t.docBaseUrl || (0, r.isDataScheme)(t
                                .docBaseUrl) ? null : t.docBaseUrl,
                            E = "string" == typeof t.cMapUrl ? t.cMapUrl : null,
                            T = !1 !== t.cMapPacked,
                            M = t.CMapReaderFactory || w,
                            R = "string" == typeof t.standardFontDataUrl ? t
                            .standardFontDataUrl : null,
                            F = t.StandardFontDataFactory || C,
                            P = !0 !== t.stopAtErrors,
                            k = Number.isInteger(t.maxImageSize) && t.maxImageSize > -
                            1 ? t.maxImageSize : -1,
                            D = !1 !== t.isEvalSupported,
                            I = "boolean" == typeof t.isOffscreenCanvasSupported ? t
                            .isOffscreenCanvasSupported : !n.isNodeJS,
                            L = Number.isInteger(t.canvasMaxAreaInBytes) ? t
                            .canvasMaxAreaInBytes : -1,
                            O = "boolean" == typeof t.disableFontFace ? t
                            .disableFontFace : n.isNodeJS,
                            ...
                            q = "boolean" == typeof t.useSystemFonts ? t
                            .useSystemFonts : !n.isNodeJS && !O,
                            G = "boolean" == typeof t.useWorkerFetch ? t
                            .useWorkerFetch : M === r.DOMCMapReaderFactory && F === r
                            .DOMStandardFontDataFactory && E && R && (0, r
                                .isValidFetchUrl)(E, document.baseURI) && (0, r
                                .isValidFetchUrl)(R, document.baseURI),
                        ...
                        A.promise.then((function () {
                            if (e.destroyed) throw new Error(
                                "Loading aborted");
                            ...
                            return Promise.all([t, h]).then((function ([t,
                                ...
                                if (e.destroyed)
                                    throw new Error(
                                        "Loading aborted");
                                const n = new c.MessageHandler(
                                        i, t, A.port),
                                    a = new WorkerTransport(n,
                                        e, s, J, K);
                                e._transport = a;
                                n.send("Ready", null)
                            }))
                    ...
                    async function _fetchDocument(t, e) {
                        ...
                        const i = await t.messageHandler.sendWithPromise(
                            "GetDocRequest", e, e.data ? [e.data.buffer] : null);
                        if (t.destroyed) throw new Error("Worker was destroyed");
                        return i
                    }
                    ...
                    function getDataProp(t) {
                        if (n.isNodeJS && "undefined" != typeof Buffer &&
                            t instanceof Buffer) throw new Error(
                            "Please provide binary data as `Uint8Array`, rather than `Buffer`."
                        );
                        if (t instanceof Uint8Array && t.byteLength === t.buffer
                            .byteLength) return t;
                        if ("string" == typeof t) return (0, n.stringToBytes)(t);
                        if ("object" == typeof t && !isNaN(t ? .length) || (0, n
                                .isArrayBuffer)(t)) return new Uint8Array(t);
                        throw new Error(
                    ...
                    class PDFDocumentLoadingTask {
                        ...
                        async destroy() {
                            this.destroyed = !0;
                            try {
                                this._worker ? .port && (this._worker
                                    ._pendingDestroy = !0);
                                await (this._transport ? .destroy())
                            } catch (t) {
                                this._worker ? .port && delete this._worker
                                    ._pendingDestroy;
                                throw t
                            }
                            this._transport = null;
                    ...
                    class PDFDataRangeTransport {
                        ...
                        onDataProgressiveRead(t) {
                            this._readyCapability.promise.then((() => {
                                for (const e of this
                                        ._progressiveReadListeners) e(t)
                            }))
                        }
                        onDataProgressiveDone() {
                            this._readyCapability.promise.then((() => {
                                for (const t of this
                                        ._progressiveDoneListeners) t()
                            }))
                        }
                        transportReady() {
                    ...
                    class PDFDocumentProxy {
                        ...
                        get isPureXfa() {
                            return (0, n.shadow)(this, "isPureXfa", !!this
                    ...
                    class PDFPageProxy {
                        ...
                        async getXfa() {
                            return this._transport._htmlForXfa ? .children[this
                                ._pageIndex] || null
                        }
                        render({
                            canvasContext: t,
                            ...
                            const p = !!(c.renderingIntent & n.RenderingIntentFlag
                                .PRINT);
                            ...
                            const complete = t => {
                                    ...
                                    (this._maybeCleanupAfterRender || p) && (this
                                        .#V = !0);
                                    this.#q(!p);
                                    if (t) {
                            ...
                            const m = g.task;
                            Promise.all([u.displayReadyCapability.promise, o]).then(
                                (([t, e]) => {
                        ...
                        getOperatorList({
                            ...
                            const s = this._transport.getRenderingIntent(t, e, i, !
                                0);
                                ...
                                a.operatorListChanged =
                                    function operatorListChanged() {
                                        if (r.operatorList.lastChunk) {
                                            r.opListReadCapability.resolve(r
                                                .operatorList);
                        ...
                        getTextContent(t = {}) {
                            if (this._transport._htmlForXfa) return this.getXfa()
                                .then((t => A.XfaText.textContent(t)));
                        ...
                        _pumpOperatorList({
                            ...
                            const {
                                map: s,
                                transfer: n
                            } = i, a = this._transport.messageHandler
                            ...
                            if (t.streamReader) {
                                ...
                                if (!i) {
                                    ...
                                    if (e instanceof r
                                        ...
                                        let i = _;
                                        e.extraDelay > 0 && e.extraDelay < 1e3 && (
                                            i += e.extraDelay);
                                ...
                                t.streamReader.cancel(new n.AbortException(e
                                    .message)).catch((() => {}));
                                t.streamReader = null;
                    ...
                    class PDFWorker {
                        ...
                        constructor({
                            ...
                            if (e) {
                                if (PDFWorker.#X ? .has(e)) throw new Error(
                        ...
                        _initializeFromPort(t) {
                            this._port = t;
                            this._messageHandler = new c.MessageHandler("main",
                                "worker", t);
                        ...
                        _initialize() {
                            if (!T.isWorkerDisabled && !PDFWorker.#K) {
                                ...
                                try {
                                    T.isSameOrigin(window.location.href, t) || (t =
                                        T.createCDNWrapper(new URL(t, window
                                            .location).href));
                                    const e = new Worker(t, {
                                            type: "module"
                                        }),
                                        i = new c.MessageHandler("main", "worker",
                                            e),
                                        terminateEarly = () => {
                                            ...
                                            i.destroy();
                                            e.terminate();
                                            this.destroyed ? this._readyCapability
                                                .reject(new Error(
                        ...
                        _setupFakeWorker() {
                            ...
                            PDFWorker._setupFakeWorkerGlobal.then((t => {
                                ...
                                const i = "fake" + T.fakeWorkerId++,
                                    s = new c.MessageHandler(i +
                                        "_worker", i, e);
                                t.setup(s, e);
                                const n = new c.MessageHandler(i, i +
                                    "_worker", e);
                                ...
                                this._readyCapability.reject(new Error(
                        ...
                        static get workerSrc() {
                            if (d.GlobalWorkerOptions.workerSrc) return d
                        ...
                        static get _setupFakeWorkerGlobal() {
                            return (0, n.shadow)(this, "_setupFakeWorkerGlobal", (
                                async () => {
                                    if (this.#K) return this.#K;
                                    return (await import(this
                                            .workerSrc))
                    ...
                    class WorkerTransport {
                        ...
                        constructor(t, e, i, s, a) {
                            ...
                            this.standardFontDataFactory = a
                        ...
                        get annotationStorage() {
                            return (0, n.shadow)(this, "annotationStorage", new a
                                .AnnotationStorage)
                        }
                        getRenderingIntent(t, e = n.AnnotationMode.ENABLE, i = null,
                            s = !1) {
                            ...
                            switch (e) {
                                ...
                                case n.AnnotationMode.ENABLE_STORAGE:
                                    ...
                                    o = (r & n.RenderingIntentFlag.PRINT &&
                                        i instanceof a.PrintAnnotationStorage ?
                                        i : this.annotationStorage).serializable;
                                    break;
                                default:
                                    (0, n.warn)(
                        ...
                        destroy() {
                            if (this.destroyCapability) return this
                                .destroyCapability.promise;
                            this.destroyed = !0;
                            this.destroyCapability = new n.PromiseCapability;
                            this.#Z ? .reject(new Error(
                            ...
                            this.#J.clear();
                            this.#Q.clear();
                            this.hasOwnProperty("annotationStorage") && this
                        ...
                        setupMessageHandler() {
                            ...
                            t.on("GetReader", ((t, e) => {
                                (0, n.assert)(this._networkStream,
                                    "GetReader - no `IPDFStream` instance available."
                                );
                                this._fullReader = this._networkStream
                                    .getFullReader();
                            ...
                            t.on("GetRangeReader", ((t, e) => {
                                ...
                                const i = this._networkStream
                                    .getRangeReader(t.begin, t.end);
                                if (i) {
                                    e.onPull = () => {
                            ...
                            t.on("DocException", (function (t) {
                                ...
                                switch (t.name) {
                                    case "PasswordException":
                                        i = new n.PasswordException(t
                                            .message, t.code);
                                        break;
                                    case "InvalidPDFException":
                                        i = new n.InvalidPDFException(t
                                            .message);
                                        break;
                                    case "MissingPDFException":
                                        i = new n.MissingPDFException(t
                                            .message);
                                        break;
                            ...
                            t.on("PasswordRequest", (t => {
                                ...
                                if (e.onPassword) {
                                    ...
                                    try {
                                        e.onPassword(updatePassword, t
                                            .code)
                                    } catch (t) {
                                        this.#Z.reject(t)
                                    }
                                } else this.#Z.reject(new n
                                    .PasswordException(t.message, t
                                        .code));
                            ...
                            t.on("StartRenderPage", (t => {
                                ...
                                this.#J.get(t.pageIndex)
                                    ._startRenderPage(t.transparency, t
                                        .cacheKey)
                            }));
                            t.on("commonobj", (([e, i, s]) => {
                                if (!this.destroyed && !this.commonObjs
                                    .has(e)) switch (i) {
                                    case "Font":
                            ...
                            t.on("FetchBuiltInCMap", (t => this.destroyed ? Promise
                                .reject(new Error(
                                    "Worker was destroyed.")) : this
                                .cMapReaderFactory ? this.cMapReaderFactory
                                .fetch(t) : Promise.reject(new Error(
                                    "CMapReaderFactory not initialized, see the `useWorkerFetch` parameter."
                                ))));
                            t.on("FetchStandardFontData", (t => this.destroyed ?
                                Promise.reject(new Error(
                                    "Worker was destroyed.")) : this
                                .standardFontDataFactory ? this
                                .standardFontDataFactory.fetch(t) : Promise
                                .reject(new Error(
                        ...
                        saveDocument() {
                            this.annotationStorage.size <= 0 && (0, n.warn)(
                        ...
                        getPage(t) {
                            if (!Number.isInteger(t) || t <= 0 || t > this
                                ._numPages) return Promise.reject(new Error(
                            ...
                            const s = this.messageHandler.sendWithPromise(
                                ...
                                if (this.destroyed) throw new Error(
                                    "Transport destroyed");
                                const i = new PDFPageProxy(e, t, this,
                                    this._params.pdfBug);
                                this.#J.set(e, i);
                                return i
                            }));
                        ...
                        getPageIndex(t) {
                            return "object" != typeof t || null === t || !Number
                                .isInteger(t.num) || t.num < 0 || !Number.isInteger(
                                    t.gen) || t.gen < 0 ? Promise.reject(new Error(
                                    "Invalid pageIndex request.")) : this
                                .messageHandler.sendWithPromise("GetPageIndex", {
                                    num: t.num,
                                    gen: t.gen
                                })
                        }
                        ...
                        getDestination(t) {
                            return "string" != typeof t ? Promise.reject(new Error(
                                    "Invalid destination request.")) : this
                                .messageHandler.sendWithPromise("GetDestination", {
                                    id: t
                                })
                        }
                        getPageLabels() {
                        ...
                        getOptionalContentConfig() {
                            return this.messageHandler.sendWithPromise(
                                "GetOptionalContentConfig", null).then((t =>
                                new p.OptionalContentConfig(t)))
                        }
                        getPermissions() {
                            return this.messageHandler.sendWithPromise(
                                "GetPermissions", null)
                        ...
                        getMetadata() {
                            const t = "GetMetadata",
                                e = this.#Y.get(t);
                            if (e) return e;
                            const i = this.messageHandler.sendWithPromise(t, null)
                                .then((t => ({
                                    info: t[0],
                                    metadata: t[1] ? new u.Metadata(t[
                                        1]) : null,
                                    contentDispositionFilename: this
                                        ._fullReader ? .filename ? ?
                                        null,
                                    contentLength: this._fullReader ?
                                        .contentLength ? ? null
                                })));
                            this.#Y.set(t, i);
                            return i
                        ...
                        async startCleanup(t = !1) {
                            if (!this.destroyed) {
                                await this.messageHandler.sendWithPromise("Cleanup",
                                    null);
                                for (const t of this.#J.values()) {
                                    if (!t.cleanup()) throw new Error(
                    ...
                    class PDFObjects {
                        ...
                        get(t, e = null) {
                            ...
                            const i = this.#et[t];
                            if (!i ? .capability.settled) throw new Error(
                    ...
                    class InternalRenderTask {
                        ...
                        constructor({
                            ...
                            this._useRequestAnimationFrame = !0 === d &&
                        ...
                        initializeGraphics({
                            ...
                            if (this._pdfBug && globalThis.StepperManager ?
                                .enabled) {
                                this.stepper = globalThis.StepperManager.create(this
                                    ._pageIndex);
                                this.stepper.init(this.operatorList);
                                this.stepper.nextBreakPoint = this.stepper
                                    .getNextBreakPoint()
                            }
                            const {
                                canvasContext: i,
                            ...
                            this.gfx = new h.CanvasGraphics(i, this.commonObjs, this
                                .objs, this.canvasFactory, this.filterFactory, {
                                    optionalContentConfig: e
                        ...
                        cancel(t = null, e = 0) {
                            ...
                            this.callback(t || new r.RenderingCancelledException(
                                `Rendering cancelled, page ${this._pageIndex+1}`,
                                e))
                        }
                        operatorListChanged() {
                            if (this.graphicsReady) {
                                this.stepper ? .updateOperatorList(this
                                    .operatorList);
                                this.running || this._continue()
                            } else this.graphicsReadyCallback || = this
                                ._continueBound
                        }
                        _continue() {
                            this.running = !0;
                            this.cancelled || (this.task.onContinue ? this.task
                                .onContinue(this._scheduleNextBound) : this
                                ._scheduleNext())
                        }
                        _scheduleNext() {
                            this._useRequestAnimationFrame ? window
                                .requestAnimationFrame((() => {
                                    this._nextBound().catch(this
                                        ._cancelBound)
                        ...
                        async _next() {
                            if (!this.cancelled) {
                                this.operatorListIdx = this.gfx.executeOperatorList(
                                    this.operatorList, this.operatorListIdx,
        ...
        822: (t, e, i) => {
            ...
            class BaseFilterFactory {
                constructor() {
                    this.constructor === BaseFilterFactory && (0, s.unreachable)(
            ...
            class BaseCanvasFactory {
                constructor() {
                    this.constructor === BaseCanvasFactory && (0, s.unreachable)(
            ...
            class BaseCMapReaderFactory {
                constructor({
                    ...
                    this.constructor === BaseCMapReaderFactory && (0, s.unreachable)(
                ...
                async fetch({
                    ...
                    if (!this.baseUrl) throw new Error(
                    ...
                    const e = this.baseUrl + t + (this.isCompressed ? ".bcmap" : ""),
                        i = this.isCompressed ? s.CMapCompressionType.BINARY : s.CMapCompressionType
                        .NONE;
            ...
            class BaseStandardFontDataFactory {
                constructor({
                    ...
                    this.constructor === BaseStandardFontDataFactory && (0, s.unreachable)(
            ...
            class BaseSVGFactory {
                constructor() {
                    this.constructor === BaseSVGFactory && (0, s.unreachable)(
        ...
        250: (t, e, i) => {
            ...
            class BaseShadingPattern {
                constructor() {
                    this.constructor === BaseShadingPattern && (0, s.unreachable)(
            ...
            class RadialAxialShadingPattern extends BaseShadingPattern {
                ...
                _createGradient(t) {
                    let e;
                    "axial" === this._type ? e = t.createLinearGradient(this._p0[0], this._p0[1],
                        this._p1[0], this._p1[1]) : "radial" === this._type && (e = t
                ...
                getPattern(t, e, i, o) {
                    let l;
                    if (o === r || o === a) {
                        const a = e.current.getClippedPathBoundingBox(o, (0, n.getCurrentTransform)(
                                t)) || [0, 0, 0, 0],
                    ...
                    case "lattice":
                        ...
                        for (a = 0; a < l; a++) {
                            ...
                            for (let a = 0; a < h; a++, e++) {
                                ...
                                drawTriangle(t, i, s[e + o + 1], s[e + 1], s[e + o], n[e + o + 1], n[e +
                                    1], n[e + o])
                            }
                        }
                        break;
                    case "triangles":
                        for (a = 0, r = s.length; a < r; a += 3) drawTriangle(t, i, s[a], s[a + 1], s[
                            a + 2], n[a], n[a + 1], n[a + 2]);
                        break;
                    default:
            ...
            class MeshShadingPattern extends BaseShadingPattern {
                ...
                getPattern(t, e, i, a) {
                    applyBoundingBox(t, this._bbox);
                    let r;
                    if (a === o) r = s.Util.singularValueDecompose2dScale((0, n.getCurrentTransform)
                        (t));
                    else {
                    ...
                    const l = this._createMeshCanvas(r, a === o ? null : this._background, e
                        .cachedCanvases);
                    if (a !== o) {
            ...
            function copyCtxState(t, e) {
                const i = ["strokeStyle", "fillStyle", "fillRule", "globalAlpha", "lineWidth",
                    "lineCap", "lineJoin", "miterLimit", "globalCompositeOperation", "font",
                    "filter"
                ];
            ...
            function composeSMask(t, e, i, s) {
                ...
                if (0 !== r && 0 !== o) {
                    ...
                    }(e.context, i, r, o, e.subtype, e.backdrop, e.transferMap, n, a, e.offsetX, e
                        .offsetY);
                    t.save();
                    t.globalAlpha = 1;
                    t.globalCompositeOperation = "source-over";
            ...
            function getImageSmoothingEnabled(t, e) {
                ...
                i[0] = Math.fround(i[0]);
                i[1] = Math.fround(i[1]);
                const a = Math.fround((globalThis.devicePixelRatio || 1) * n.PixelsPerInch
                    .PDF_TO_CSS_UNITS);
            ...
            class CanvasGraphics {
                constructor(t, e, i, s, n, {
                    ...
                    this.ctx = t;
                    this.current = new CanvasExtraState(this.ctx.canvas.width, this.ctx.canvas
                        .height);
                    this.stateStack = [];
                ...
                getObject(t, e = null) {
                    return "string" == typeof t ? t.startsWith("g_") ? this.commonObjs.get(t) : this
                        .objs.get(t) : e
                }
                beginDrawing({
                    transform: t,
                ...
                endDrawing() {
                    ...
                    for (const t of this._cachedBitmapsMap.values()) {
                        for (const e of t.values()) "undefined" != typeof HTMLCanvasElement &&
                            e instanceof HTMLCanvasElement && (e.width = e.height = 0);
                        t.clear()
                    }
                ...
                rt() {
                    if (this.pageColors) {
                        const t = this.filterFactory.addHCMFilter(this.pageColors.foreground, this
                ...
                _createMaskCanvas(t) {
                    ...
                    const [m, f, b, A] = s.Util.getAxialAlignedBoundingBox([0, 0, i, r], g), v =
                        Math.round(b - m) || 1, y = Math.round(A - f) || 1, _ = this.cachedCanvases
                        .getCanvas("fillCanvas", v, y), E = _.context, x = m, w = f;
                    E.translate(-x, -w);
                    E.transform(...g);
                    if (!u) {
                    ...
                    E.imageSmoothingEnabled = getImageSmoothingEnabled((0, n.getCurrentTransform)(
                        E), t.interpolate);
                    drawImageAtIntegerCoords(E, u, 0, 0, u.width, u.height, 0, 0, i, r);
                    E.globalCompositeOperation = "source-in";
                    const S = s.Util.transform((0, n.getCurrentTransformInverse)(E), [1, 0, 0, 1, -
                        x, -w
                    ]);
                ...
                setGState(t) {
                    for (const [e, i] of t) switch (e) {
                        ...
                        case "SMask":
                            ...
                            break;
                        case "TR":
                            this.ctx.filter = this.current.transferMaps = this.filterFactory
                                .addFilter(i)
                    }
                }
                get inSMaskMode() {
                ...
                checkSMaskState() {
                    ...
                    this.current.activeSMask && !t ? this.beginSMaskMode() : !this.current
                        .activeSMask && t && this.endSMaskMode()
                }
                beginSMaskMode() {
                    if (this.inSMaskMode) throw new Error(
                    ...
                    ! function mirrorContextOperations(t, e) {
                        if (t._removeMirroring) throw new Error(
                ...
                constructPath(t, e, i) {
                    ...
                    for (let i = 0, n = 0, g = t.length; i < g; i++) switch (0 | t[i]) {
                        ...
                        case s.OPS.curveTo:
                            ...
                            r.updateCurvePathMinMax(c, o, l, e[n], e[n + 1], e[n + 2], e[n + 3],
                                h, d, p);
                            n += 6;
                            break;
                        case s.OPS.curveTo2:
                            ...
                            r.updateCurvePathMinMax(c, o, l, h, d, e[n], e[n + 1], e[n + 2], e[
                                n + 3], p);
                            h = e[n + 2];
                            d = e[n + 3];
                            n += 4;
                ...
                stroke(t = !0) {
                    ...
                    if (this.contentVisible)
                        if ("object" == typeof i && i ? .getPattern) {
                            e.save();
                            e.strokeStyle = i.getPattern(e, this, (0, n.getCurrentTransformInverse)(
                                e), r);
                ...
                fill(t = !0) {
                    ...
                    if (this.current.patternFill) {
                        e.save();
                        e.fillStyle = i.getPattern(e, this, (0, n.getCurrentTransformInverse)(e),
                            a);
                        s = !0
                    }
                ...
                setFont(t, e) {
                    ...
                    0 !== n.fontMatrix[0] && 0 !== n.fontMatrix[3] || (0, s.warn)(
                ...
                paintChar(t, e, i, a) {
                    ...
                    if (l.disableFontFace || p) {
                        ...
                        g(r, d);
                        a && r.setTransform(...a);
                        c !== s.TextRenderingMode.FILL && c !== s.TextRenderingMode.FILL_STROKE || r
                            .fill();
                        c !== s.TextRenderingMode.STROKE && c !== s.TextRenderingMode.FILL_STROKE ||
                            r.stroke();
                        r.restore()
                    } else {
                        c !== s.TextRenderingMode.FILL && c !== s.TextRenderingMode.FILL_STROKE || r
                ...
                showText(t) {
                    ...
                    const o = this.ctx,
                        ...
                        f = i.defaultVMetrics,
                        b = r * e.fontMatrix[0],
                        A = e.textRenderingMode === s.TextRenderingMode.FILL && !i
                        .disableFontFace && !e.patternFill;
                    o.save();
                    ...
                    if (e.patternFill) {
                        o.save();
                        const t = e.fillColor.getPattern(o, this, (0, n.getCurrentTransformInverse)(
                            o), a);
                ...
                getColorN_Pattern(t) {
                    ...
                    if ("TilingPattern" === t[0]) {
                        const i = t[1],
                            ...
                            a = {
                                createCanvasGraphics: t => new CanvasGraphics(t, this.commonObjs,
                                    this.objs, this.canvasFactory, this.filterFactory, {
                ...
                shadingFill(t) {
                    ...
                    if (a) {
                        const {
                            width: t,
                            height: i
                        } = e.canvas, [n, r, o, l] = s.Util.getAxialAlignedBoundingBox([0, 0, t, i],
                            a);
                ...
                beginGroup(t) {
                    ...
                    let a = s.Util.getAxialAlignedBoundingBox(t.bbox, (0, n.getCurrentTransform)(
                        e));
                ...
                endGroup(t) {
                    ...
                    if (t.smask) {
                        ...
                        const i = s.Util.getAxialAlignedBoundingBox([0, 0, e.canvas.width, e.canvas
                            .height
                        ], t);
                ...
                beginAnnotation(t, e, i, a, r) {
                    ...
                    if (Array.isArray(e) && 4 === e.length) {
                        ...
                        if (r && this.annotationCanvasMap) {
                            ...
                            e[2] = a;
                            e[3] = o;
                            const [r, l] = s.Util.singularValueDecompose2dScale((0, n
                                .getCurrentTransform)(this.ctx)), {
                                viewportScale: h
                            } = this, d = Math.ceil(a * this.outputScaleX * h), c = Math.ceil(
                ...
                paintImageMaskXObject(t) {
                    ...
                    if (s) {
                        void 0 === s.compiled && (s.compiled = function compileType3Glyph(t) {
                            ...
                            const s = new Uint8Array([0, 2, 4, 0, 1, 0, 5, 4, 8, 10, 0, 8,
                                    0, 2, 1, 0
                                ]),
                                n = e + 1;
                ...
                paintImageMaskXObjectGroup(t) {
                    ...
                    for (const r of t) {
                        const {
                            ...
                            height: l,
                            transform: h
                        } = r, d = this.cachedCanvases.getCanvas("maskCanvas", o, l), c = d.context;
                        c.save();
                        putBinaryImageMask(c, this.getObject(t, r));
                        c.globalCompositeOperation = "source-in";
                        c.fillStyle = s ? i.getPattern(c, this, (0, n.getCurrentTransformInverse)(
                            e), a) : i;
                        c.fillRect(0, 0, o, l);
                        c.restore();
                        e.save();
                ...
                paintImageXObject(t) {
                    ...
                    e ? this.paintInlineImageXObject(e) : (0, s.warn)(
                ...
                paintInlineImageXObject(t) {
                    ...
                    else if ("function" == typeof HTMLElement && t instanceof HTMLElement || !t
                        .data) r = t;
                    else {
                    ...
                    a.imageSmoothingEnabled = getImageSmoothingEnabled((0, n.getCurrentTransform)(
                        a), t.interpolate);
                    drawImageAtIntegerCoords(a, o.img, 0, 0, o.paintWidth, o.paintHeight, 0, -i, e,
                        i);
                    this.compose();
                    this.restore()
                }
                ...
                getSinglePixelWidth() {
                    if (!this._cachedGetSinglePixelWidth) {
                        const t = (0, n.getCurrentTransform)(this.ctx);
                        if (0 === t[1] && 0 === t[2]) this._cachedGetSinglePixelWidth = 1 / Math
                            .min(Math.abs(t[0]), Math.abs(t[3]));
                        else {
            ...
            for (const t in s.OPS) void 0 !== CanvasGraphics.prototype[t] && (CanvasGraphics.prototype[s
                .OPS[t]] = CanvasGraphics.prototype[t])
        },
        473: (t, e, i) => {
            i.d(e, {
            ...
            class DOMFilterFactory extends s.BaseFilterFactory {
                ...
                addFilter(t) {
                    ...
                    if (1 === t.length) {
                        ...
                        const [a, r, o] = t, l = new Array(256), h = new Array(256), d =
                            new Array(256);
                        for (let t = 0; t < 256; t++) {
                            l[t] = a[t] / 255;
                            h[t] = r[t] / 255;
                ...
                addHighlightHCMFilter(t, e, i, s) {
                    ...
                    const getSteps = (t, e, i) => {
                        ...
                        u = this.#pt = this.#vt(c);
                    this.#Et(u);
                    this.#yt(getSteps(h[0], d[0], 5), getSteps(h[1], d[1], 5), getSteps(h[2], d[
                        2], 5), u);
                    this.#mt = `url(#${c})`;
                    return this.#mt
                }
            ...
            async function fetchData(t, e = !1) {
                if (isValidFetchUrl(t, document.baseURI)) {
                    ...
                    return e ? new Uint8Array(await i.arrayBuffer()) : (0, n.stringToBytes)(await i
                        .text())
                }
                    ...
                    a.onreadystatechange = () => {
                        if (a.readyState === XMLHttpRequest.DONE) {
                            if (200 === a.status || 0 === a.status) {
                                let t;
                                e && a.response ? t = new Uint8Array(a.response) : !
                                    e && a.responseText && (t = (0, n.stringToBytes)
                                        (a.responseText));
                                if (t) {
                                    i(t);
                                    return
            ...
            class PageViewport {
                constructor({
                    ...
                    this.transform = [l * e, h * e, d * e, c * e, u - l * e * r - d * e * o, p - h *
                        e * r - c * e * o
                    ];
                    this.width = g;
                    this.height = m
            ...
            function getRGB(t) {
                ...
                if (t.startsWith("rgba(")) return t.slice(5, -1).split(",").map((t => parseInt(t)))
                    .slice(0, 3);
                ...
                if (e instanceof PageViewport) {
                    const {
                        ...
                        pageHeight: a
                            ...
                            style: r
                        } = t, o = n.FeatureTest.isCSSRoundSupported, l =
                        `var(--scale-factor) * ${s}px`, h = `var(--scale-factor) * ${a}px`, d = o ?
                        `round(${l}, 1px)` : `calc(${l})`, c = o ? `round(${h}, 1px)` : `calc(${h})`;
        ...
        331: (t, e, i) => {
            ...
            class FreeTextEditor extends n.AnnotationEditor {
                ...
                St = this.editorDivFocus.bind(this);#
                Ct = this.editorDivInput.bind(this);#
                Tt = this.editorDivKeydown.bind(this);#
                u;#
                Mt = "";#
                Rt = `${this.id}-editor`;#
                Ft;#
                ...
                static get _keyboardManager() {
                    ...
                    return (0, s.shadow)(this, "_keyboardManager", new a.KeyboardManager([
                        [
                            ["ctrl+s", "mac+meta+s", "ctrl+p", "mac+meta+p"], t
                            .commitOrRemove, {
                                bubbles: !0
                            }
                        ],
                        [
                            ["ctrl+Enter", "mac+meta+Enter", "Escape",
                                "mac+Escape"
                            ], t.commitOrRemove
                        ],
                        [
                ...
                constructor(t) {
                    ...
                    this.#u = t.color || FreeTextEditor._defaultColor || n.AnnotationEditor
                        ._defaultLineColor;
                    this.#Ft = t.fontSize || FreeTextEditor._defaultFontSize
                }
                static initialize(t) {
                ...
                static get defaultPropertiesToUpdate() {
                    return [
                        [s.AnnotationEditorParamsType.FREETEXT_SIZE, FreeTextEditor
                            ._defaultFontSize
                        ],
                        [s.AnnotationEditorParamsType.FREETEXT_COLOR, FreeTextEditor
                            ._defaultColor || n.AnnotationEditor._defaultLineColor
                        ]
                    ]
                }
                get propertiesToUpdate() {
                    return [
                        [s.AnnotationEditorParamsType.FREETEXT_SIZE, this.#Ft],
                        [s.AnnotationEditorParamsType.FREETEXT_COLOR, this.#u]
                    ]
                }#
                kt(t) {
                    const setFontsize = t => {
                            this.editorDiv.style.fontSize =
                                `calc(${t}px * var(--scale-factor))`;
                            this.translate(0, -(t - this.#Ft) * this.parentScale);
                            this.#Ft = t;
                            this.#It()
                        },
                        e = this.#Ft;
                ...
                getInitialTranslation() {
                    ...
                    return [-FreeTextEditor._internalPadding * t, -(FreeTextEditor
                        ._internalPadding + this.#Ft) * t]
                }
                rebuild() {
                    if (this.parent) {
                        super.rebuild();
                ...
                enableEditMode() {
                    if (!this.isInEditMode()) {
                        ...
                        this.editorDiv.addEventListener("keydown", this.#Tt);
                        this.editorDiv.addEventListener("focus", this.#St);
                ...
                disableEditMode() {
                    if (this.isInEditMode()) {
                        ...
                        this.div.setAttribute("aria-activedescendant", this.#Rt);
                        this._isDraggable = !0;
                        this.editorDiv.removeEventListener("keydown", this.#Tt);
                        this.editorDiv.removeEventListener("focus", this.#St);
                ...
                render() {
                    ...
                    this.editorDiv.setAttribute("id", this.#Rt);
                    this.editorDiv.setAttribute("data-l10n-id", "pdfjs-free-text");
                    this.enableEditing();
                    n.AnnotationEditor._l10nPromise.get("pdfjs-free-text-default-content").then(
                        (t => this.editorDiv ? .setAttribute("default-content", t)))
                    this.editorDiv.contentEditable = !0;
                    const {
                        style: i
                    } = this.editorDiv;
                    i.fontSize = `calc(${this.#Ft}px * var(--scale-factor))`;
                    i.color = this.#u;
                ...
                Bt() {
                    ...
                    if (this.#Mt)
                        for (const t of this.#Mt.split("\n")) {
                            const e = document.createElement("div");
                            e.append(t ? document.createTextNode(t) : document.createElement(
                                "br"));
                ...
                serialize(t = !1) {
                    ...
                    const e = FreeTextEditor._internalPadding * this.parentScale,
                        i = this.getRect(e, e),
                        a = n.AnnotationEditor._colorManager.convert(this.isAttachedToDOM ?
                            getComputedStyle(this.editorDiv).color : this.#u),
                        r = {
                            annotationType: s.AnnotationEditorType.FREETEXT,
                            color: a,
                            fontSize: this.#Ft,
                    ...
                    if (t) return r;
                    if (this.annotationElementId && !this.#Nt(r)) return null;
                ...
                Nt(t) {
                    ...
                    return t.value !== e || t.fontSize !== i || t.rect.some(((t, e) => Math.abs(
                            t - n[e]) >= 1)) || t.color.some(((t, e) => t !== s[e])) || t
                        .pageIndex !== a
                }#
                Lt(t = !1) {
                    ...
                    if (!t && (0 === this.width || 0 === this.height)) {
                        setTimeout((() => this.#Lt(!0)), 0);
                        return
                    }
                    const e = FreeTextEditor._internalPadding * this.parentScale;
                    this.#Pt.rect = this.getRect(e, e)
                }
            }
            var o = i(473);
            class InkEditor extends n.AnnotationEditor {
                ...
                Ut = 0;#
                zt = 0;#
                Ht = this.canvasPointermove.bind(this);#
                jt = this.canvasPointerleave.bind(this);#
                Vt = this.canvasPointerup.bind(this);#
                ...
                static get defaultPropertiesToUpdate() {
                    return [
                        [s.AnnotationEditorParamsType.INK_THICKNESS, InkEditor
                            ._defaultThickness
                        ],
                        [s.AnnotationEditorParamsType.INK_COLOR, InkEditor._defaultColor ||
                            n.AnnotationEditor._defaultLineColor
                        ],
                        [s.AnnotationEditorParamsType.INK_OPACITY, Math.round(100 *
                            InkEditor._defaultOpacity)]
                    ]
                }
                get propertiesToUpdate() {
                    return [
                        [s.AnnotationEditorParamsType.INK_THICKNESS, this.thickness ||
                            InkEditor._defaultThickness
                        ],
                        [s.AnnotationEditorParamsType.INK_COLOR, this.color || InkEditor
                            ._defaultColor || n.AnnotationEditor._defaultLineColor
                        ],
                        [s.AnnotationEditorParamsType.INK_OPACITY, Math.round(100 * (this
                            .opacity ? ? InkEditor._defaultOpacity))]
                    ]
                }#
                te(t) {
                ...
                setParent(t) {
                    !this.parent && t ? this._uiManager.removeShouldRescale(this) : this
                        .parent && null === t && this._uiManager.addShouldRescale(this);
                    super.setParent(t)
                }
                onScaleChanging() {
                    const [t, e] = this.parentDimensions, i = this.width * t, s = this.height *
                        e;
                    this.setDimensions(i, s)
                }
                enableEditMode() {
                    if (!this.#$t && null !== this.canvas) {
                        super.enableEditMode();
                        this._isDraggable = !1;
                ...
                isEmpty() {
                    return 0 === this.paths.length || 1 === this.paths.length && 0 === this
                        .paths[0].length
                }#
                oe() {
                    const {
                ...
                he(t, e) {
                    ...
                    this.canvas.addEventListener("pointerleave", this.#jt);
                    this.canvas.addEventListener("pointermove", this.#Ht);
                    this.canvas.addEventListener("pointerup", this.#Vt);
                    this.canvas.removeEventListener("pointerdown", this.#Wt);
                    this.isEditing = !0;
                    if (!this.#Kt) {
                        this.#Kt = !0;
                        ...
                        this.color || = InkEditor._defaultColor || n.AnnotationEditor
                            ._defaultLineColor;
                    ...
                    this.#Zt = () => {
                        this.#de();
                        this.#Zt && window.requestAnimationFrame(this.#Zt)
                    };
                    window.requestAnimationFrame(this.#Zt)
                }#
                ce(t, e) {
                    ...
                    if (n.length <= 2) {
                        ...
                        if (3 === n.length) {
                            this.#Gt = a = new Path2D;
                            a.moveTo(...n[0])
                        }
                        this.#ue(a, ...n.at(-3), ...n.at(-2), t, e)
                    }
                }#
                pe() {
                ...
                ge(t, e) {
                    ...
                    this.#pe();
                    let i;
                    if (1 !== this.currentPath.length) i = this.#me();
                    else {
                        const s = [t, e];
                        i = [
                            [s, s.slice(), s.slice(), s]
                ...
                de() {
                    ...
                    const t = Math.ceil(this.thickness * this.parentScale),
                        ...
                        {
                            ctx: n
                        } = (Math.min(...i), Math.max(...i), Math.min(...s), Math.max(...s),
                            this);
                    n.save();
                ...
                ue(t, e, i, s, n, a, r) {
                    const o = (e + s) / 2,
                        ...
                        h = (s + a) / 2,
                        d = (n + r) / 2;
                    t.bezierCurveTo(o + 2 * (s - o) / 3, l + 2 * (n - l) / 3, h + 2 * (s - h) /
                        3, d + 2 * (n - d) / 3, h, d)
                }#
                me() {
                    ...
                    for (i = 1; i < t.length - 2; i++) {
                        const [a, r] = t[i], [o, l] = t[i + 1], h = (a + o) / 2, d = (r + l) /
                            2, c = [s + 2 * (a - s) / 3, n + 2 * (r - n) / 3], u = [h + 2 * (a -
                                h) / 3, d + 2 * (r - d) / 3];
                        e.push([
                            [s, n], c, u, [h, d]
                        ]);
                    ...
                    const [a, r] = t[i], [o, l] = t[i + 1], h = [s + 2 * (a - s) / 3, n + 2 * (
                        r - n) / 3], d = [o + 2 * (a - o) / 3, l + 2 * (r - l) / 3];
                    e.push([
                        [s, n], h, d, [o, l]
                    ]);
                    return e
                ...
                canvasPointerdown(t) {
                    if (0 === t.button && this.isInEditMode() && !this.#$t) {
                        this.setInForeground();
                        t.preventDefault();
                        "mouse" !== t.type && this.div.focus();
                        this.#he(t.offsetX, t.offsetY)
                    }
                }
                canvasPointermove(t) {
                    t.preventDefault();
                ...
                be(t) {
                    this.canvas.removeEventListener("pointerleave", this.#jt);
                    this.canvas.removeEventListener("pointermove", this.#Ht);
                    this.canvas.removeEventListener("pointerup", this.#Vt);
                    this.canvas.addEventListener("pointerdown", this.#Wt);
                    this.#qt && clearTimeout(this.#qt);
                    this.#qt = setTimeout((() => {
                        this.#qt = null;
                        this.canvas.removeEventListener("contextmenu", o
                            .noContextMenu)
                    }), 10);
                ...
                ae() {
                    this.#Yt = new ResizeObserver((t => {
                        const e = t[0].contentRect;
                        e.width && e.height && this.setDimensions(e.width, e.height)
                    }));
                    this.#Yt.observe(this.div)
                }
                get isResizable() {
                    return !this.isEmpty() && this.#$t
                }
                render() {
                    if (this.div) return this.div;
                    let t, e;
                ...
                fe() {
                    const t = this.#ve() / 2;
                    this.ctx.setTransform(this.scaleFactor, 0, 0, this.scaleFactor, this
                        .translationX * this.scaleFactor + t, this.translationY * this
                        .scaleFactor + t)
                }
                static# ye(t) {
                    const e = new Path2D;
                ...
                xe(t, e, i, s) {
                    ...
                    for (const e of this.paths) {
                        ...
                        for (let s = 0, n = e.length; s < n; s++) {
                            const [l, h, d, c] = e[s], u = t * l[0] + r, p = t * l[1] + o, g =
                                t * h[0] + r, m = t * h[1] + o, f = t * d[0] + r, b = t * d[1] +
                                o, A = t * c[0] + r, v = t * c[1] + o;
                            if (0 === s) {
                                i.push(u, p);
                                a.push(u, p)
                            }
                        ...
                        n.push({
                            bezier: InkEditor.#_e(i, s, this.rotation),
                            points: InkEditor.#_e(a, s, this.rotation)
                        })
                    }
                    return n
                }#
                ...
                ve() {
                    return this.#$t ? Math.ceil(this.thickness * this.parentScale) : 0
                }#
                ie(t = !1) {
                    ...
                    const e = this.#we(),
                        i = this.#ve();
                    this.#zt = Math.max(n.AnnotationEditor.MIN_SIZE, e[2] - e[0]);
                    this.#Ut = Math.max(n.AnnotationEditor.MIN_SIZE, e[3] - e[1]);
                    const s = Math.ceil(i + this.#zt * this.scaleFactor),
                        a = Math.ceil(i + this.#Ut * this.scaleFactor),
                ...
                static deserialize(t, e, i) {
                    ...
                    a.opacity = t.opacity;
                    const [o, l] = a.pageDimensions, h = a.width * o, d = a.height * l, c = a
                        .parentScale, u = t.thickness / 2;
                    a.#$t = !0;
                    a.#Jt = Math.round(h);
                    a.#Qt = Math.round(d);
                    const {
                    ...
                    const f = a.#we();
                    a.#zt = Math.max(n.AnnotationEditor.MIN_SIZE, f[2] - f[0]);
                    a.#Ut = Math.max(n.AnnotationEditor.MIN_SIZE, f[3] - f[1]);
                    a.#Ae(h, d);
                    return a
                }
                serialize() {
                    ...
                    return {
                        ...
                        paths: this.#xe(this.scaleFactor / this.parentScale, this.translationX,
                            this.translationY, t),
                        pageIndex: this.pageIndex,
                        rect: t,
                        rotation: this.rotation,
            ...
            class StampEditor extends n.AnnotationEditor {
                ...
                constructor(t) {
                    ...
                    this.#Me = t.bitmapUrl;
                    this.#Re = t.bitmapFile
                }
                static initialize(t) {
                    n.AnnotationEditor.initialize(t)
                }
                static get supportedTypes() {
                    return (0, s.shadow)(this, "supportedTypes", ["apng", "avif", "bmp", "gif",
                        "jpeg", "png", "svg+xml", "webp", "x-icon"
                    ].map((t => `image/${t}`)))
                }
                ...
                Be() {
                    if (this.#Ce) {
                        ...
                        this._uiManager.imageManager.getFromId(this.#Ce).then((t => this.#Le(t,
                            !0))).finally((() => this.#Oe()));
                        return
                    }
                    if (this.#Me) {
                        ...
                        this.#Me = null;
                        this._uiManager.enableWaiting(!0);
                        this.#Te = this._uiManager.imageManager.getFromUrl(t).then((t => this
                            .#Le(t))).finally((() => this.#Oe()));
                        return
                    }
                    if (this.#Re) {
                        const t = this.#Re;
                        this.#Re = null;
                        this._uiManager.enableWaiting(!0);
                        this.#Te = this._uiManager.imageManager.getFromFile(t).then((t => this
                            .#Le(t))).finally((() => this.#Oe()));
                        return
                    }
                    ...
                    this.#Te = new Promise((e => {
                        t.addEventListener("change", (async () => {
                            if (t.files && 0 !== t.files.length) {
                                this._uiManager.enableWaiting(!0);
                                const e = await this._uiManager
                                    .imageManager.getFromFile(t
                                        .files[0]);
                                this.#Le(e)
                            } else this.remove();
                            e()
                ...
                remove() {
                    if (this.#Ce) {
                        this.#Se = null;
                        this._uiManager.imageManager.deleteId(this.#Ce);
                        this.#Pe ? .remove();
                        this.#Pe = null;
                        this.#Yt ? .disconnect();
                        this.#Yt = null;
                ...
                isEmpty() {
                    return !(this.#Te || this.#Se || this.#Me || this.#Re)
                }
                get isResizable() {
                    return !0
                }
                ...
                ne() {
                    ...
                    this._uiManager.enableWaiting(!1);
                    const l = this.#Pe = document.createElement("canvas");
                    t.append(l);
                    t.hidden = !1;
                    this.#Ne(e, i);
                    this.#ae();
                    ...
                    this.#Fe && l.setAttribute("aria-label", this.#Fe)
                }#
                Ue(t, e) {
                    const [i, s] = this.parentDimensions;
                    this.width = t / i;
                    this.height = e / s;
                    this.setDims(t, e);
                    this._initialOptions ? .isCentered ? this.center() : this
                        .fixAndSetPosition();
                    this._initialOptions = null;
                    null !== this.#ke && clearTimeout(this.#ke);
                    this.#ke = setTimeout((() => {
                        this.#ke = null;
                        this.#Ne(t, e)
                    }), 200)
                ...
                ze(t, e) {
                    ...
                    for (; n > 2 * t || a > 2 * e;) {
                        const i = n,
                            s = a;
                        n > 2 * t && (n = n >= 16384 ? Math.floor(n / 2) - 1 : Math.ceil(n /
                            2));
                        a > 2 * e && (a = a >= 16384 ? Math.floor(a / 2) - 1 : Math.ceil(a /
                            2));
                ...
                Ne(t, e) {
                    ...
                    i.width = t;
                    i.height = e;
                    const s = this.#De ? this.#Se : this.#ze(t, e),
                        n = i.getContext("2d");
                ...
                He(t) {
                    if (t) {
                        if (this.#De) {
                            const t = this._uiManager.imageManager.getSvgUrl(this.#Ce);
                            if (t) return t
                        }
                        ...
                        t.getContext("2d").drawImage(this.#Se, 0, 0);
                        return t.toDataURL()
                    }
                    if (this.#De) {
                        const [t, e] = this.pageDimensions, i = Math.round(this.width * t * o
                            .PixelsPerInch.PDF_TO_CSS_UNITS), s = Math.round(this.height *
                            e * o.PixelsPerInch.PDF_TO_CSS_UNITS), n = new OffscreenCanvas(
                            i, s);
                        n.getContext("2d").drawImage(this.#Se, 0, 0, this.#Se.width, this.#Se
                            .height, 0, 0, i, s);
                        return n.transferToImageBitmap()
                    }
                    return structuredClone(this.#Se)
                }#
                ae() {
                    this.#Yt = new ResizeObserver((t => {
                        const e = t[0].contentRect;
                        e.width && e.height && this.#Ue(e.width, e.height)
                    }));
                    this.#Yt.observe(this.div)
                }
                static deserialize(t, e, i) {
                    ...
                    o && i.imageManager.isValidId(o) ? s.#Ce = o : s.#Me = a;
                    s.#De = l;
                ...
                serialize(t = !1, e = null) {
                    ...
                    if (null === e) return i;
                    e.stamps || = new Map;
                    const r = this.#De ? (i.rect[2] - i.rect[0]) * (i.rect[3] - i.rect[1]) :
                        null;
                    if (e.stamps.has(this.#Ce)) {
                        if (this.#De) {
                            const t = e.stamps.get(this.#Ce);
                            if (r > t.area) {
                                t.area = r;
                                t.serialized.bitmap.close();
                                t.serialized.bitmap = this.#He(!1)
                            }
                        }
                    } else {
                        e.stamps.set(this.#Ce, {
                            area: r,
                            serialized: i
                        });
                        i.bitmap = this.#He(!1)
            ...
            class AnnotationEditorLayer {
                ...
                static# Qe = new Map([FreeTextEditor, InkEditor, StampEditor].map((t => [t._editorType,
                    t
                ])));
                constructor({
                    uiManager: t,
                    ...
                    const o = [...AnnotationEditorLayer.#Qe.values()];
                    ...
                    this.#Ve = n;
                    this.viewport = a;
                    this.#Je.addLayer(this)
                }
                get isEmpty() {
                    return 0 === this.#$e.size
                }
                updateToolbar(t) {
                    this.#Je.updateToolbar(t)
                }
                updateMode(t = this.#Je.getMode()) {
                    this.#Ze();
                    ...
                    if (t !== s.AnnotationEditorType.NONE) {
                        ...
                        for (const i of AnnotationEditorLayer.#Qe.values()) e.toggle(
                            `${i._type}Editing`, t === i._editorType);
                        this.div.hidden = !1
                    }
                }
                addInkEditorIfNeeded(t) {
                    if (!t && this.#Je.getMode() !== s.AnnotationEditorType.INK) return;
                    if (!t)
                ...
                setEditingState(t) {
                    this.#Je.setEditingState(t)
                }
                addCommands(t) {
                    this.#Je.addCommands(t)
                }
                ...
                enable() {
                    ...
                    if (!this.#Ve) return;
                    const e = this.#Ve.getEditableAnnotations();
                    for (const i of e) {
                        i.hide();
                        if (this.#Je.isDeletedAnnotationElement(i.data.id)) continue;
                ...
                disable() {
                    ...
                    if (this.#Ve) {
                        ...
                        for (const i of e) {
                            ...
                            t.has(e) || this.#Je.isDeletedAnnotationElement(e) || i.show()
                        }
                    }
                    this.#Ze();
                    ...
                    for (const t of AnnotationEditorLayer.#Qe.values()) e.remove(
                        `${t._type}Editing`);
                    this.#Ye = !1
                }
                getEditableAnnotation(t) {
                    return this.#Ve ? .getEditableAnnotation(t) || null
                }
                setActiveEditor(t) {
                    this.#Je.getActive() !== t && this.#Je.setActiveEditor(t)
                }
                enableClick() {
                    this.div.addEventListener("pointerdown", this.#qe);
                    this.div.addEventListener("pointerup", this.#We)
                }
                disableClick() {
                    this.div.removeEventListener("pointerdown", this.#qe);
                ...
                attach(t) {
                    ...
                    e && this.#Je.isDeletedAnnotationElement(e) && this.#Je
                        .removeDeletedAnnotationElement(t)
                }
                detach(t) {
                    this.#$e.delete(t.id);
                    this.#k ? .removePointerInTextLayer(t.contentDiv);
                    !this.#Ye && t.annotationElementId && this.#Je.addDeletedAnnotationElement(t)
                }
                remove(t) {
                    this.detach(t);
                    this.#Je.removeEditor(t);
                    t.div.remove();
                    t.isAttachedToDOM = !1;
                ...
                changeParent(t) {
                    if (t.parent !== this) {
                        if (t.annotationElementId) {
                            this.#Je.addDeletedAnnotationElement(t.annotationElementId);
                ...
                add(t) {
                    ...
                    t.fixAndSetPosition();
                    t.onceAdded();
                    this.#Je.addToAnnotationStorage(t)
                }
                moveEditorInDOM(t) {
                    ...
                    if (t.div.contains(e) && !this.#Ge) {
                        t._focusEventsAllowed = !1;
                        this.#Ge = setTimeout((() => {
                            this.#Ge = null;
                            if (t.div.contains(document.activeElement)) t
                    ...
                    t._structTreeParentId = this.#k ? .moveElementInDOM(this.div, t.div, t
                        .contentDiv, !0)
                }
                addOrRebuild(t) {
                ...
                ei(t) {
                    const e = AnnotationEditorLayer.#Qe.get(this.#Je.getMode());
                    return e ? new e.prototype.constructor(t) : null
                }
                pasteEditor(t, e) {
                    this.#Je.updateToolbar(t);
                    this.#Je.updateMode(t);
                    const {
                        offsetX: i,
                        offsetY: s
                    } = this.#ii(), n = this.getNextId(), a = this.#ei({
                        parent: this,
                        id: n,
                        x: i,
                        y: s,
                ...
                deserialize(t) {
                    return AnnotationEditorLayer.#Qe.get(t.annotationType ? ? t
                        .annotationEditorType) ? .deserialize(t, this, this.#Je) || null
                }#
                ti(t, e) {
                ...
                ii() {
                    const {
                        ...
                        width: i,
                        height: s
                    } = this.div.getBoundingClientRect(), n = Math.max(0, t), a = Math.max(0, e),
                        r = (n + Math.min(window.innerWidth, t + i)) / 2 - t, o = (a + Math.min(
                            window.innerHeight, e + s)) / 2 - e, [l, h] = this.viewport.rotation %
                        180 == 0 ? [r, o] : [o, r];
                    return {
                        offsetX: l,
                        offsetY: h
                ...
                setSelected(t) {
                    this.#Je.setSelected(t)
                }
                toggleSelected(t) {
                    this.#Je.toggleSelected(t)
                }
                isSelected(t) {
                    return this.#Je.isSelected(t)
                }
                unselect(t) {
                    this.#Je.unselect(t)
                }
                pointerup(t) {
                    ...
                    if (!(0 !== t.button || t.ctrlKey && e) && t.target === this.div && this.#Xe) {
                        this.#Xe = !1;
                        this.#je ? this.#Je.getMode() !== s.AnnotationEditorType.STAMP ? this.#ti(t,
                            !1) : this.#Je.unselectAll() : this.#je = !0
                    }
                }
                pointerdown(t) {
                    if (this.#Xe) {
                    ...
                    this.#Xe = !0;
                    const i = this.#Je.getActive();
                    this.#je = !i || i.isEmpty()
                }
                findNewParent(t, e, i) {
                    const s = this.#Je.findParent(e, i);
                    if (null === s || s === this) return !1;
                    s.changeParent(t);
                    return !0
                }
                destroy() {
                    if (this.#Je.getActive() ? .parent === this) {
                        this.#Je.commitOrRemove();
                        this.#Je.setActiveEditor(null)
                    }
                    if (this.#Ge) {
                    ...
                    this.div = null;
                    this.#$e.clear();
                    this.#Je.removeLayer(this)
                }#
                Ze() {
                    this.#Ke = !0;
                    for (const t of this.#$e.values()) t.isEmpty() && t.remove();
                    this.#Ke = !1
                }
                render({
                    viewport: t
                    ...
                    for (const t of this.#Je.getEditors(this.pageIndex)) this.add(t);
                    this.updateMode()
                }
                update({
                    viewport: t
        ...
        682: (t, e, i) => {
            ...
            class AnnotationEditor {
                ...
                ci = null;#
                ui = null;#
                pi = this.focusin.bind(this);#
                gi = this.focusout.bind(this);#
                mi = "";#
                fi = !1;#
                bi = !1;#
                Ai = !1;#
                ...
                static get _resizerKeyboardManager() {
                    ...
                    return (0, n.shadow)(this, "_resizerKeyboardManager", new s.KeyboardManager([
                        ...
                        [
                            ["Escape", "mac+Escape"], AnnotationEditor.prototype
                            ._stopResizingWithKeyboard
                        ]
                    ]))
                }
                constructor(t) {
                    this.constructor === AnnotationEditor && (0, n.unreachable)(
                ...
                static get _defaultLineColor() {
                    return (0, n.shadow)(this, "_defaultLineColor", this._colorManager.getHexCode(
                        "CanvasText"))
                }
                ...
                static initialize(t, e = null) {
                    ...
                    ].map((e => [e, t.get(e.replaceAll(/([A-Z])/g, (t =>
                        `-${t.toLowerCase()}`)))])));
                    if (e ? .strings)
                        for (const i of e.strings) AnnotationEditor._l10nPromise.set(i, t.get(i));
                    if (-1 !== AnnotationEditor._borderLineWidth) return;
                    const i = getComputedStyle(document.documentElement);
                    AnnotationEditor._borderLineWidth = parseFloat(i.getPropertyValue(
                        "--outline-width")) || 0
                }
                static updateDefaultParams(t, e) {}
                static get defaultPropertiesToUpdate() {
                ...
                focusin(t) {
                    this._focusEventsAllowed && (this.#fi ? this.#fi = !1 : this.parent.setSelected(
                        this))
                }
                focusout(t) {
                ...
                translate(t, e) {
                    this.#wi(this.parentDimensions, t, e)
                }
                translateInPage(t, e) {
                    this.#wi(this.pageDimensions, t, e);
                ...
                screenToPageTranslation(t, e) {
                    return AnnotationEditor.#Ci(t, e, this.parentRotation)
                }
                pageTranslationToScreen(t, e) {
                    return AnnotationEditor.#Ci(t, e, 360 - this.parentRotation)
                }#
                Ti(t) {
                    switch (t) {
                        case 90: {
                ...
                get parentDimensions() {
                    ...
                    return n.FeatureTest.isCSSRoundSupported ? [Math.round(s), Math.round(a)] : [s,
                        a
                    ]
                }
                setDims(t, e) {
                    ...
                    this.#di || (this.div.style.height = `${(100*e/s).toFixed(2)}%`);
                    this.#ri ? .classList.toggle("small", t < AnnotationEditor.SMALL_EDITOR_SIZE ||
                ...
                fixDims() {
                    const {
                        ...
                        height: e,
                        width: i
                    } = t, s = i.endsWith("%"), n = !this.#di && e.endsWith("%");
                    if (s && n) return;
                    const [a, r] = this.parentDimensions;
                    s || (t.width = `${(100*parseFloat(i)/a).toFixed(2)}%`);
                    this.#di || n || (t.height = `${(100*parseFloat(e)/r).toFixed(2)}%`)
                }
                getInitialTranslation() {
                    return [0, 0]
                }#
                Mi() {
                    ...
                    this.#ci.classList.add("resizers");
                    const t = this._willKeepAspectRatio ? ["topLeft", "topRight", "bottomRight",
                        "bottomLeft"
                    ...
                    for (const e of t) {
                        ...
                        t.addEventListener("pointerdown", this.#Ri.bind(this, e));
                        t.addEventListener("contextmenu", a.noContextMenu);
                        t.tabIndex = -1
                    }
                    this.div.prepend(this.#ci)
                }#
                Ri(t, e) {
                    e.preventDefault();
                    const {
                    ...
                    this.div.style.cursor = this.parent.div.style.cursor = window.getComputedStyle(e
                        .target).cursor;
                ...
                Pi(t, e) {
                    const [i, s] = this.parentDimensions, n = this.x, a = this.y, r = this.width,
                        o = this.height, l = AnnotationEditor.MIN_SIZE / i, h = AnnotationEditor
                        .MIN_SIZE / s, round = t => Math.round(1e4 * t) / 1e4, d = this.#Ti(this
                            .rotation), transf = (t, e) => [d[0] * t + d[2] * e, d[1] * t + d[3] *
                            e
                        ], c = this.#Ti(360 - this.rotation);
                    let u, p, g = !1,
                        m = !1;
                    switch (t) {
                        case "topLeft":
                    ...
                    if (g) {
                        ...
                        _ = E = Math.max(Math.min(Math.hypot(b[0] - f[0] - x, b[1] - f[1] - w) / t,
                            1 / r, 1 / o), l / r, h / o)
                    } else m ? _ = Math.max(l, Math.min(1, Math.abs(b[0] - f[0] - x))) / r : E =
                        Math.max(h, Math.min(1, Math.abs(b[1] - f[1] - w))) / o;
                    const T = round(r * _),
                        M = round(o * E);
                    A = transf(...p(T, M));
                    const R = v - A[0],
                ...
                async addAltTextButton() {
                    if (this.#ri) return;
                    const t = this.#ri = document.createElement("button");
                    t.className = "altText";
                    ...
                    if (!AnnotationEditor.SMALL_EDITOR_SIZE) {
                        const e = 40;
                        AnnotationEditor.SMALL_EDITOR_SIZE = Math.min(128, Math.round(t
                            .getBoundingClientRect().width * (1 + e / 100)))
                    }
                }
                async# Di() {
                    const t = this.#ri;
                    ...
                    AnnotationEditor._l10nPromise.get("pdfjs-editor-alt-text-edit-button-label")
                        .then((e => {
                            t.setAttribute("aria-label", e)
                        }));
                    let e = this.#oi;
                    if (!e) {
                        this.#oi = e = document.createElement("span");
                        e.className = "tooltip";
                        ...
                        t.addEventListener("mouseleave", (() => {
                            ...
                            this.#oi ? .classList.remove("show")
                        }))
                    }
                    e.innerText = this.#ai ? await AnnotationEditor._l10nPromise.get(
                        "pdfjs-editor-alt-text-decorative-tooltip") : this.#ni;
                ...
                render() {
                    ...
                    this.setInForeground();
                    this.div.addEventListener("focusin", this.#pi);
                    this.div.addEventListener("focusout", this.#gi);
                    const [t, e] = this.parentDimensions;
                ...
                Ii(t) {
                    ...
                    if (e) {
                        ...
                        s = t => {
                            const [e, i] = this.screenToPageTranslation(t.movementX, t
                                .movementY);
                    ...
                    const pointerUpCallback = () => {
                        ...
                        if (!this._uiManager.endDragSession()) {
                            ...
                            t.ctrlKey && !e || t.shiftKey || t.metaKey && e ? this.parent
                                .toggleSelected(this) : this.parent.setSelected(this)
                        }
                    };
                    window.addEventListener("pointerup", pointerUpCallback);
                    window.addEventListener("blur", pointerUpCallback)
                ...
                static deserialize(t, e, i) {
                    ...
                    const [n, a] = s.pageDimensions, [r, o, l, h] = s.getRectInCurrentCoords(t.rect,
                        a);
                    s.x = r / n;
                    s.y = o / a;
                    s.width = l / n;
                ...
                remove() {
                    this.div.removeEventListener("focusin", this.#pi);
                    this.div.removeEventListener("focusout", this.#gi);
                    this.isEmpty() || this.commit();
                ...
                makeResizable() {
                    if (this.isResizable) {
                        this.#Mi();
                        this.#ci.classList.remove("hidden");
                ...
                keydown(t) {
                    ...
                    const e = this.#ci.children;
                    if (!this.#si) {
                        this.#si = Array.from(e);
                        const t = this.#Li.bind(this),
                            i = this.#Oi.bind(this);
                        for (const e of this.#si) {
                            const s = e.getAttribute("data-resizer-name");
                            e.setAttribute("role", "spinbutton");
                            e.addEventListener("keydown", t);
                            e.addEventListener("blur", i);
                            e.addEventListener("focus", this.#Bi.bind(this, s));
                            AnnotationEditor._l10nPromise.get(`pdfjs-editor-resizer-label-${s}`)
                    ...
                    const n = (360 - this.rotation + this.parentRotation) % 360 / 90 * (this.#si
                        .length / 4);
                    if (n !== s) {
                        if (n < s)
                            for (let t = 0; t < s - n; t++) this.#ci.append(this.#ci.firstChild);
                        else if (n > s)
                            for (let t = 0; t < n - s; t++) this.#ci.firstChild.before(this.#ci
                                .lastChild);
                        let t = 0;
                        for (const i of e) {
                            const e = this.#si[t++].getAttribute("data-resizer-name");
                            AnnotationEditor._l10nPromise.get(`pdfjs-editor-resizer-label-${e}`)
                                .then((t => i.setAttribute("aria-label", t)))
                        }
                    }
                    this.#Ni(0);
                    this.#vi = !0;
                    this.#ci.firstChild.focus({
                        focusVisible: !0
                    });
                    t.preventDefault();
                ...
                Oi(t) {
                    this.#vi && t.relatedTarget ? .parentNode !== this.#ci && this.#xi()
                }#
                Bi(t) {
                    this.#mi = this.#vi ? t : ""
                }#
                Ni(t) {
                    if (this.#si)
                        for (const e of this.#si) e.tabIndex = t
                }
                _resizeWithKeyboard(t, e) {
                    this.#vi && this.#Pi(this.#mi, {
                        movementX: t,
                        movementY: e
                    })
                }#
                ...
                unselect() {
                    this.#ci ? .classList.add("hidden");
                    this.div ? .classList.remove("selectedEditor");
                    this.div ? .contains(document.activeElement) && this._uiManager.currentLayer.div
                        .focus()
                }
                updateParams(t, e) {}
                disableEditing() {
                    this.#ri && (this.#ri.hidden = !0)
                }
                enableEditing() {
                    this.#ri && (this.#ri.hidden = !1)
                }
                enterInEditMode() {}
                getImageForAltText() {
                    return null
        ...
        812: (t, e, i) => {
            ...
            class ImageManager {
                ...
                static get _isSVGFittingCanvas() {
                    ...
                    const i = e.decode().then((() => {
                        ...
                        return 0 === new Uint32Array(t.getImageData(0, 0, 1, 1).data
                            .buffer)[0]
                    }));
                ...
                async getFromFile(t) {
                    ...
                    return this.#zi(`${e}_${i}_${s}_${n}`, t)
                }
                async getFromUrl(t) {
                    return this.#zi(t, t)
                }
                ...
                isValidId(t) {
                    return t.startsWith(`image_${this.#Ui}_`)
                }
            }
            class CommandManager {
                ...
                add({
                    ...
                    if (-1 === this.#Wi) {
                        this.#Hi.length > 0 && (this.#Hi.length = 0);
                        this.#Wi = 0;
                        this.#Hi.push(r);
                        return
                    }
                    if (n && this.#Hi[this.#Wi].type === s) {
                        a && (r.undo = this.#Hi[this.#Wi].undo);
                        this.#Hi[this.#Wi] = r;
                        return
                    }
                    const o = this.#Wi + 1;
                    if (o === this.#Vi) this.#Hi.splice(0, 1);
                    else {
                        this.#Wi = o;
                        o < this.#Hi.length && this.#Hi.splice(o)
                    }
                    this.#Hi.push(r)
                }
                undo() {
                    if (-1 !== this.#Wi) {
                        this.#ji = !0;
                        this.#Hi[this.#Wi].undo();
                        this.#ji = !1;
                        this.#Wi -= 1
                    }
                }
                redo() {
                    if (this.#Wi < this.#Hi.length - 1) {
                        this.#Wi += 1;
                        this.#ji = !0;
                        this.#Hi[this.#Wi].cmd();
                        this.#ji = !1
                ...
                hasSomethingToRedo() {
                    return this.#Wi < this.#Hi.length - 1
                }
                destroy() {
                    this.#Hi = null
                }
            ...
            class KeyboardManager {
                ...
                exec(t, e) {
                    ...
                    const i = this.callbacks.get(this.#qi(e));
                    if (!i) return;
                    const {
                        callback: s,
                        options: {
            ...
            class ColorManager {
                ...
                convert(t) {
                    ...
                    for (const [t, i] of this._colors)
                        if (i.every(((t, i) => t === e[i]))) return ColorManager._colorsMapping.get(
                            t);
                    return e
                }
                getHexCode(t) {
            ...
            class AnnotationEditorUIManager {
                ...
                rs = !1;#
                os = null;#
                ls = s.AnnotationEditorType.NONE;#
                hs = new Set;#
                ds = null;#
                cs = this.blur.bind(this);#
                us = this.focus.bind(this);#
                ps = this.copy.bind(this);#
                gs = this.cut.bind(this);#
                ms = this.paste.bind(this);#
                fs = this.keydown.bind(this);#
                bs = this.onEditingAction.bind(this);#
                As = this.onPageChanging.bind(this);#
                vs = this.onScaleChanging.bind(this);#
                ys = this.onRotationChanging.bind(this);#
                _s = {
                    isEditing: !1,
                    isEmpty: !0,
                ...
                static get _keyboardManager() {
                    const t = AnnotationEditorUIManager.prototype,
                        arrowChecker = t => t.#p.contains(document.activeElement) && t
                    ...
                    return (0, s.shadow)(this, "_keyboardManager", new KeyboardManager([
                        ...
                        [
                            ["Backspace", "alt+Backspace", "ctrl+Backspace",
                                "shift+Backspace", "mac+Backspace", "mac+alt+Backspace",
                                "mac+ctrl+Backspace", "Delete", "ctrl+Delete",
                                "shift+Delete", "mac+Delete"
                            ], t.delete, {
                                checker: textInputChecker
                            }
                        ],
                ...
                constructor(t, e, i, s, a, r) {
                    ...
                    this.#Ki = i;
                    this._eventBus = s;
                    this._eventBus._on("editingaction", this.#bs);
                    this._eventBus._on("pagechanging", this.#As);
                    this._eventBus._on("scalechanging", this.#vs);
                    this._eventBus._on("rotationchanging", this.#ys);
                    this.#Yi = a.annotationStorage;
                    this.#is = a.filterFactory;
                    this.#ds = r;
                    this.viewParameters = {
                ...
                destroy() {
                    this.#Ss();
                    this.#Cs();
                    this._eventBus._off("editingaction", this.#bs);
                    this._eventBus._off("pagechanging", this.#As);
                    this._eventBus._off("scalechanging", this.#vs);
                    this._eventBus._off("rotationchanging", this.#ys);
                    for (const t of this.#Xi.values()) t.destroy();
                    this.#Xi.clear();
                    this.#$i.clear();
                    this.#es.clear();
                    this.#Gi = null;
                ...
                get hcmFilter() {
                    return (0, s.shadow)(this, "hcmFilter", this.#ds ? this.#is.addHCMFilter(this
                        .#ds.foreground, this.#ds.background) : "none")
                }
                get direction() {
                    return (0, s.shadow)(this, "direction", getComputedStyle(this.#p).direction)
                }
                editAltText(t) {
                    this.#Ki ? .editAltText(this, t)
                }
                onPageChanging({
                    pageNumber: t
                }) {
                ...
                disableUserSelect(t = !1) {
                    this.#ws.classList.toggle("noUserSelect", t)
                }
                addShouldRescale(t) {
                    this.#es.add(t)
                }
                ...
                addToAnnotationStorage(t) {
                    t.isEmpty() || !this.#Yi || this.#Yi.has(t.id) || this.#Yi.setValue(t.id, t)
                }#
                Ts() {
                    window.addEventListener("focus", this.#us);
                    window.addEventListener("blur", this.#cs)
                }#
                Cs() {
                    window.removeEventListener("focus", this.#us);
                    window.removeEventListener("blur", this.#cs)
                }
                blur() {
                ...
                Ms() {
                    window.addEventListener("keydown", this.#fs)
                }#
                Ss() {
                    window.removeEventListener("keydown", this.#fs)
                }#
                Rs() {
                    document.addEventListener("copy", this.#ps);
                    document.addEventListener("cut", this.#gs);
                    document.addEventListener("paste", this.#ms)
                }#
                Fs() {
                    document.removeEventListener("copy", this.#ps);
                    document.removeEventListener("cut", this.#gs);
                    document.removeEventListener("paste", this.#ms)
                }
                addEditListeners() {
                    this.#Ms();
                    this.#Rs()
                ...
                copy(t) {
                    ...
                    0 !== e.length && t.clipboardData.setData("application/pdfjs", JSON.stringify(
                        e))
                }
                cut(t) {
                    this.copy(t);
                ...
                keydown(t) {
                    this.isEditorHandlingKeyboard || AnnotationEditorUIManager._keyboardManager
                        .exec(this, t)
                }
                onEditingAction(t) {
                ...
                Ds(t) {
                    Object.entries(t).some((([t, e]) => this.#_s[t] !== e)) && this._eventBus
                        .dispatch("annotationeditorstateschanged", {
                            source: this,
                            details: Object.assign(this.#_s, t)
                        })
                }#
                Is(t) {
                ...
                setEditingState(t) {
                    if (t) {
                        ...
                        this.#Rs();
                        this.#Ds({
                            isEditing: this.#ls !== s.AnnotationEditorType.NONE,
                            isEmpty: this.#Ls(),
                            hasSomethingToUndo: this.#Ji.hasSomethingToUndo(),
                            hasSomethingToRedo: this.#Ji.hasSomethingToRedo(),
                            hasSelectedEditor: !1
                        })
                    } else {
                        this.#Cs();
                ...
                registerEditorTypes(t) {
                    if (!this.#Qe) {
                        this.#Qe = t;
                        for (const t of this.#Qe) this.#Is(t.defaultPropertiesToUpdate)
                    }
                }
                getId() {
                ...
                addLayer(t) {
                    this.#Xi.set(t.pageIndex, t);
                    this.#as ? t.enable() : t.disable()
                }
                removeLayer(t) {
                    this.#Xi.delete(t.pageIndex)
                }
                updateMode(t, e = null, i = !1) {
                    if (this.#ls !== t) {
                        ...
                        if (t !== s.AnnotationEditorType.NONE) {
                            ...
                            this.#Os();
                            this.unselectAll();
                            for (const e of this.#Xi.values()) e.updateMode(t);
                            if (e || !i) {
                                if (e)
                ...
                updateToolbar(t) {
                    t !== this.#ls && this._eventBus.dispatch("switchannotationeditormode", {
                        source: this,
                        mode: t
                    })
                }
                updateParams(t, e) {
                    if (this.#Qe)
                        if (t !== s.AnnotationEditorParamsType.CREATE) {
                            ...
                            for (const i of this.#Qe) i.updateDefaultParams(t, e)
                ...
                Os() {
                    if (!this.#as) {
                        this.#as = !0;
                        for (const t of this.#Xi.values()) t.enable()
                    }
                }#
                Bs() {
                    this.unselectAll();
                    if (this.#as) {
                        this.#as = !1;
                        for (const t of this.#Xi.values()) t.disable()
                    }
                }
                getEditors(t) {
                    const e = [];
                ...
                removeEditor(t) {
                    ...
                    this.#$i.delete(t.id);
                    this.unselect(t);
                    t.annotationElementId && this.#Zi.has(t.annotationElementId) || this.#Yi ?
                        .remove(t.id)
                }
                addDeletedAnnotationElement(t) {
                    this.#Zi.add(t.annotationElementId);
                    t.deleted = !0
                }
                isDeletedAnnotationElement(t) {
                    return this.#Zi.has(t)
                }
                removeDeletedAnnotationElement(t) {
                    this.#Zi.delete(t.annotationElementId);
                    t.deleted = !1
                }#
                Ps(t) {
                    const e = this.#Xi.get(t.pageIndex);
                ...
                hasSomethingToControl() {
                    return this.#Gi || this.hasSelection
                }#
                ks(t) {
                    this.#hs.clear();
                    for (const e of t)
                ...
                selectAll() {
                    ...
                    this.#ks(this.#$i.values())
                }
                unselectAll() {
                    if (this.#Gi) this.#Gi.commitOrRemove();
                ...
                translateSelectedEditors(t, e, i = !1) {
                    ...
                    this.#xs = setTimeout((() => {
                        ...
                        this.addCommands({
                            cmd: () => {
                                for (const t of a) this.#$i.has(t.id) && t
                                    .translateInPage(s, n)
                            },
                            undo: () => {
                                for (const t of a) this.#$i.has(t.id) && t
                ...
                setUpDragSession() {
                    if (this.hasSelection) {
                        ...
                        this.#ts = new Map;
                        for (const t of this.#hs) this.#ts.set(t, {
                            savedX: t.x,
                            savedY: t.y,
                ...
                dragSelectedEditors(t, e) {
                    if (this.#ts)
                        for (const i of this.#ts.keys()) i.drag(t, e)
                }
                rebuild(t) {
                    if (null === t.parent) {
                ...
                get isEditorHandlingKeyboard() {
                    return this.getActive() ? .shouldGetKeyboardEvents() || 1 === this.#hs.size &&
        ...
        171: (t, e, i) => {
            ...
            class PDFFetchStreamReader {
                constructor(t) {
                    ...
                    const i = e.url;
                    fetch(i, createFetchOptions(this._headers, this._withCredentials, this
                        ._abortController)).then((t => {
                        if (!(0, n.validateResponseStatus)(t.status)) throw (0, n
                            .createResponseStatusError)(t.status, i);
                        ...
                        this._filename = (0, n.extractFilenameFromHeader)(
                            getResponseHeader);
                        !this._isStreamingSupported && this._isRangeSupported && this
                            .cancel(new s.AbortException("Streaming is disabled."))
            ...
            class PDFFetchStreamRangeReader {
                constructor(t, e, i) {
                    ...
                    const r = a.url;
                    fetch(r, createFetchOptions(this._headers, this._withCredentials, this
                        ._abortController)).then((t => {
                        if (!(0, n.validateResponseStatus)(t.status)) throw (0, n
                            .createResponseStatusError)(t.status, r);
            ...
            class FontLoader {
                ...
                insertRule(t) {
                    if (!this.styleElement) {
                        ...
                        this._document.documentElement.getElementsByTagName("head")[0].append(this
                            .styleElement)
                    }
                ...
                async loadSystemFont({
                    ...
                    if (t && !this.#Ns.has(t.loadedName)) {
                        (0, s.assert)(!this.disableFontFace,
                ...
                get isSyncFontLoadingSupported() {
                    let t = !1;
                    (s.isNodeJS || "undefined" != typeof navigator && "string" == typeof navigator ?
                        .userAgent && /Mozilla\/5.0.*?rv:\d+.*? Gecko/.test(navigator.userAgent)) &&
                    (t = !0);
                ...
                _prepareFontLoadEvent(t, e) {
                    function int32(t, e) {
                        return t.charCodeAt(e) << 24 | t.charCodeAt(e + 1) << 16 | t.charCodeAt(e +
                            2) << 8 | 255 & t.charCodeAt(e + 3)
                    }
                    ...
                    const u =
                        `@font-face {font-family:"${l}";src:${`url(data:font/opentype;base64,${btoa(h)});`}}`;
                    this.insertRule(u);
                    ...
                    ! function isFontReady(t, e) {
                        ...
                        r.font = "30px " + t;
                        r.fillText(".", 0, 20);
                        r.getImageData(0, 0, 1, 1).data[3] > 0 ? e() : setTimeout(isFontReady.bind(
                            null, t, e))
                    }(l, (() => {
                        p.remove();
                        e.complete()
            ...
            class FontFaceObject {
                ...
                createNativeFontFace() {
                    ...
                    if (this.cssFontInfo) {
                        ...
                        this.cssFontInfo.italicAngle && (e.style =
                            `oblique ${this.cssFontInfo.italicAngle}deg`);
                ...
                createFontFaceRule() {
                    ...
                    if (this.cssFontInfo) {
                        ...
                        this.cssFontInfo.italicAngle && (t +=
                            `font-style: oblique ${this.cssFontInfo.italicAngle}deg;`);
        ...
        472: (t, e, i) => {
            ...
            class Metadata {
                ...
                getAll() {
                    return (0, s.objectFromMap)(this.#Us)
                }
                has(t) {
        ...
        474: (t, e, i) => {
            ...
            class PDFNetworkStreamFullRequestReader {
                ...
                cancel(t) {
                    ...
                    this._requests.length = 0;
                    this._manager.isPendingRequest(this._fullRequestId) && this._manager
                        .abortRequest(this._fullRequestId);
                    this._fullRequestReader = null
                }
            }
            class PDFNetworkStreamRangeRequestReader {
                ...
                cancel(t) {
                    ...
                    this._requests.length = 0;
                    this._manager.isPendingRequest(this._requestId) && this._manager.abortRequest(
                        this._requestId);
                    this._close()
                }
            }
        ...
        253: (t, e, i) => {
                ...
                if (e) {
                    let t = function getFilenameFromContentDispositionHeader(t) {
                        ...
                        function rfc2047decode(t) {
                            return !t.startsWith("=?") || /[\x00-\x19\x80-\xff]/.test(t) ? t : t
                                .replaceAll(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g, (
                                    function (t, e, i, s) {
                                        if ("q" === i || "Q" === i) return textdecode(e, s = (
                                            s = s.replaceAll("_", " ")).replaceAll(
                                            /=([0-9a-fA-F]{2})/g, (function (t, e) {
            ...
            function createResponseStatusError(t, e) {
                return 404 === t || 0 === t && e.startsWith("file:") ? new s.MissingPDFException(
                    'Missing PDF "' + e + '".') : new s.UnexpectedResponseException(
                    `Unexpected server response (${t}) while retrieving PDF "${e}".`, t)
            }
                ...
                try {
                    ...
                    class PDFNodeStream {
                        constructor(t) {
                            ...
                            this.isHttp = "http:" === this.url.protocol ||
                        ...
                        getRangeReader(t, e) {
                            if (e <= this._progressiveDataLength) return null;
                            const i = this.isFsUrl ? new PDFNodeStreamFsRangeReader(
                                this, t, e) : new PDFNodeStreamRangeReader(this,
                                t, e);
                            this._rangeRequestReaders.push(i);
                            return i
                        }
                        cancelAllRequests(t) {
                            this._fullRequestReader ? .cancel(t);
                            for (const e of this._rangeRequestReaders.slice(0)) e
                                .cancel(t)
                        }
                    }
                    class BaseFullReader {
                        constructor(t) {
                            ...
                            this._disableRange = e.disableRange || !1;
                            this._rangeChunkSize = e.rangeChunkSize;
                            this._rangeChunkSize || this._disableRange || (this
                                ._disableRange = !0);
                            this._isStreamingSupported = !e.disableStream;
                            this._isRangeSupported = !e.disableRange;
                        ...
                        cancel(t) {
                            this._readableStream ? this._readableStream.destroy(t) :
                                this._error(t)
                        }
                        _error(t) {
                            this._storedError = t;
                        ...
                        _setReadableStream(t) {
                            ...
                            !this._isStreamingSupported && this._isRangeSupported &&
                                this._error(new n.AbortException(
                                    "streaming is disabled"));
                            this._storedError && this._readableStream.destroy(this
                                ._storedError)
                        }
                    }
                    ...
                    class PDFNodeStreamFullReader extends BaseFullReader {
                        constructor(t) {
                            ...
                            const handleResponse = e => {
                                ...
                                const getResponseHeader = t => this
                                    ._readableStream.headers[t.toLowerCase()],
                                    {
                                        allowRangeRequests: i,
                                        suggestedLength: s
                            ...
                            this._request = null;
                            "http:" === this._url.protocol ? this._request = o
                                .request(createRequestOptions(this._url, t
                                    .httpHeaders), handleResponse) : this._request =
                                l.request(createRequestOptions(this._url, t
                                    .httpHeaders), handleResponse);
                    ...
                    class PDFNodeStreamRangeReader extends BaseRangeReader {
                        constructor(t, e, i) {
                            ...
                            this._request = null;
                            "http:" === this._url.protocol ? this._request = o
                                .request(createRequestOptions(this._url, this
                                    ._httpHeaders), handleResponse) : this
                                ._request = l.request(createRequestOptions(this
                                    ._url, this._httpHeaders), handleResponse);
                            this._request.on("error", (t => {
                                this._storedError = t
                            }));
                            this._request.end()
        ...
        738: (t, e, i) => {
            i.a(t, (async (t, s) => {
                try {
                    ...
                    class NodeStandardFontDataFactory extends n
            ...
            class OptionalContentConfig {
                ...
                constructor(t) {
                    ...
                    if (null !== t) {
                        ...
                        this.#qs = t.order;
                        for (const e of t.groups) this.#Vs.set(e.id, new OptionalContentGroup(e
                            .name, e.intent));
                        if ("OFF" === t.baseState)
                            for (const t of this.#Vs.values()) t._setVisible(a, !1);
                        for (const e of t.on) this.#Vs.get(e)._setVisible(a, !0);
                        for (const e of t.off) this.#Vs.get(e)._setVisible(a, !1);
                ...
                Gs(t) {
                    ...
                    for (let n = 1; n < e; n++) {
                        const e = t[n];
                        let a;
                        if (Array.isArray(e)) a = this.#Gs(e);
                        else {
                            if (!this.#Vs.has(e)) {
                                (0, s.warn)(`Optional content group not found: ${e}`);
                                return !0
                            }
                            a = this.#Vs.get(e).visible
                        }
                        switch (i) {
                            case "And":
                                if (!a) return !1;
                ...
                getOrder() {
                    return this.#Vs.size ? this.#qs ? this.#qs.slice() : [...this.#Vs.keys()] : null
                }
                getGroups() {
                    return this.#Vs.size > 0 ? (0, s.objectFromMap)(this.#Vs) : null
                }
                getGroup(t) {
                    return this.#Vs.get(t) || null
                }
                getHash() {
                    if (null !== this.#js) return this.#js;
                    const t = new n.MurmurHash3_64;
                    for (const [e, i] of this.#Vs) t.update(`${e}:${i.visible}`);
                    return this.#js = t.hexdigest()
                }
            }
        },
        739: (t, e, i) => {
            ...
            function getCtx(t, e) {
                let i;
                if (e && s.FeatureTest.isOffscreenCanvasSupported) i = new OffscreenCanvas(t, t)
                    .getContext("2d", {
                        alpha: !1
                    });
                else {
            ...
            function appendText(t, e, i) {
                ...
                n.textContent = e.str;
                n.dir = e.dir;
                t._fontInspectorEnabled && (n.dataset.fontName = c.fontSubstitutionLoadedName || e
                    .fontName);
            ...
            class TextLayerRenderTask {
                ...
                _processItems(t, e) {
                    for (const i of t)
                        if (void 0 !== i.str) {
                            ...
                            appendText(this, i, e)
                        } else if ("beginMarkedContentProps" === i.type || "beginMarkedContent" ===
                        i.type) {
                    ...
                    } else "endMarkedContent" === i.type && (this._container = this._container
                        .parentNode)
                }
                _layoutText(t) {
                ...
                _render() {
                    ...
                    if (this._isReadableStream) {
                        ...
                        if (!this._textContentSource) throw new Error(
        ...
        92: (t, e, i) => {
            ...
            class PDFDataTransportStream {
                constructor({
                    ...
                    if (e ? .length > 0) {
                        const t = e instanceof Uint8Array && e.byteLength === e.buffer.byteLength ?
                ...
                _onReceiveData({
                    ...
                    const i = e instanceof Uint8Array && e.byteLength === e.buffer.byteLength ? e
                        .buffer : new Uint8Array(e).buffer;
                    if (void 0 === t) this._fullRequestReader ? this._fullRequestReader._enqueue(
                        i) : this._queuedChunks.push(i);
                    else {
                ...
                getFullReader() {
                    ...
                    return new PDFDataTransportStreamReader(this, t, this._progressiveDone, this
            ...
            class XfaLayer {
                    ...
                    switch (i.name) {
                        ...
                        case "input":
                            if ("radio" === i.attributes.type || "checkbox" === i.attributes.type) {
                                a.value === i.attributes.xfaOn ? t.setAttribute("checked", !0) : a
                                    .value === i.attributes.xfaOff && t.removeAttribute("checked");
                                if ("print" === n) break;
                                t.addEventListener("change", (t => {
                                    s.setValue(e, {
                                        value: t.target.checked ? t.target
                                            .getAttribute("xfaOn") : t.target
                                            .getAttribute("xfaOff")
                                    })
                                }))
                            } else {
                        ...
                        case "select":
                            if (null !== a.value) {
                                ...
                                for (const t of i.children) t.attributes.value === a.value ? t
                                    .attributes.selected = !0 : t.attributes.hasOwnProperty(
                                        "selected") && delete t.attributes.selected
                            }
                            t.addEventListener("input", (t => {
                                const i = t.target.options,
                                    n = -1 === i.selectedIndex ? "" : i[i.selectedIndex]
                                    .value;
                                s.setValue(e, {
                                    value: n
                                })
                    ...
                    for (const [e, i] of Object.entries(a))
                        if (null != i) switch (e) {
                            ...
                            case "textContent":
                                ...
                                break;
                            default:
                                (!r || "href" !== e && "newWindow" !== e) && t.setAttribute(e,
                                    i)
                        }
                ...
                static render(t) {
                    ...
                    for (; d.length > 0;) {
                        ...
                        const u = l ? .attributes ? .xmlns ? document.createElementNS(l.attributes
                            .xmlns, c) : document.createElement(c);
                        r.append(u);
                    ...
                    for (const t of l.querySelectorAll(
                            ".xfaNonInteractive input, .xfaNonInteractive textarea")) t
                ...
                static textContent(t) {
                    ...
                    ! function walk(t) {
                        ...
                        if ("#text" === s) i = t.value;
                            ...
                            t ? .attributes ? .textContent ? i = t.attributes.textContent : t
                                .value && (i = t.value)
                        }
                        null !== i && e.push({
                            str: i
            ...
            i.a(t, (async (t, s) => {
                try {
                    i.d(e, {
                        ...
                        RenderingCancelledException: () => r
                            .RenderingCancelledException,
                        UnexpectedResponseException: () => n
                            .UnexpectedResponseException,
                        Util: () => n.Util,
        ...
        694: (t, e, i) => {
            ...
            function wrapReason(t) {
                t instanceof Error || "object" == typeof t && null !== t || (0, s.unreachable)(
            ...
            class MessageHandler {
                    ...
                    this._onComObjOnMessage = t => {
                        ...
                        if (e.callback) {
                            ...
                            if (e.callback === n) i.resolve(e.data);
                                ...
                                if (e.callback !== a) throw new Error(
                        ...
                        } else e.streamId ? this.#Xs(e) : s(e.data)
                    };
                ...
                $s(t) {
                    ...
                    switch (t.stream) {
                        case p:
                            t.success ? g.startCall.resolve() : g.startCall.reject(wrapReason(t
                                .reason));
                            break;
                        case u:
                            t.success ? g.pullCall.resolve() : g.pullCall.reject(wrapReason(t
                                .reason));
                            break;
                        case c:
                            if (!m) {
                        ...
                        case d:
                            ...
                            break;
                        case o:
                            t.success ? g.cancelCall.resolve() : g.cancelCall.reject(wrapReason(t
                                .reason));
                            this.#Ks(g, e);
                            break;
                        case r:
                ...
                async# Ks(t, e) {
                    await Promise.allSettled([t.startCall ? .promise, t.pullCall ? .promise, t
                        .cancelCall ? .promise
                    ])
            ...
            class MurmurHash3_64 {
                ...
                update(t) {
                    ...
                    if ("string" == typeof t) {
                        ...
                        if (!(0, s.isArrayBuffer)(t)) throw new Error(
                ...
                hexdigest() {
                    ...
                    t ^= e >>> 1;
                    return (t >>> 0).toString(16).padStart(8, "0") + (e >>> 0).toString(16)
                        .padStart(8, "0")
                }
            }
        },
        266: (t, e, i) => {
            ...
            const s = !("object" != typeof process || process + "" != "[object process]" || process
                    .versions.nw || process.versions.electron && process.type && "browser" !== process
                    .type),
                n = [1, 0, 0, 1, 0, 0],
                a = [.001, 0, 0, .001, 0, 0],
                r = 1e7,
            ...
            const x = function BaseExceptionClosure() {
                function BaseException(t, e) {
                    this.constructor === BaseException && unreachable(
            ...
            function bytesToString(t) {
                "object" == typeof t && void 0 !== t ? .length || unreachable(
            ...
            class FeatureTest {
                ...
                static get isOffscreenCanvasSupported() {
                    return shadow(this, "isOffscreenCanvasSupported", "undefined" !=
                        typeof OffscreenCanvas)
                }
                static get platform() {
                    return "undefined" != typeof navigator && "string" == typeof navigator ?
                        .platform ? shadow(this, "platform", {
                ...
                static get isCSSRoundSupported() {
                    return shadow(this, "isCSSRoundSupported", globalThis.CSS ? .supports ? .(
            ...
            class Util {
                ...
                static transform(t, e) {
                    return [t[0] * e[0] + t[2] * e[1], t[1] * e[0] + t[3] * e[1], t[0] * e[2] + t[
                            2] * e[3], t[1] * e[2] + t[3] * e[3], t[0] * e[4] + t[2] * e[5] + t[
                            4],
                        t[1] * e[4] + t[3] * e[5] + t[5]
                    ]
                }
                ...
                static applyInverseTransform(t, e) {
                    ...
                    return [(t[0] * e[3] - t[1] * e[2] + e[2] * e[5] - e[4] * e[3]) / i, (-t[0] * e[
                        1] + t[1] * e[0] + e[4] * e[1] - e[5] * e[0]) / i]
                }
                static getAxialAlignedBoundingBox(t, e) {
                    ...
                    return [Math.min(i[0], s[0], n[0], a[0]), Math.min(i[1], s[1], n[1], a[1]), Math
                        .max(i[0], s[0], n[0], a[0]), Math.max(i[1], s[1], n[1], a[1])
                    ]
                }
                static inverseTransform(t) {
                    const e = t[0] * t[3] - t[1] * t[2];
                    return [t[3] / e, -t[1] / e, -t[2] / e, t[0] / e, (t[2] * t[5] - t[4] * t[3]) /
                        e, (t[4] * t[1] - t[5] * t[0]) / e
                    ]
                }
                ...
                static bezierBoundingBox(t, e, i, s, n, a, r, o) {
                    ...
                    for (; v--;) {
                        p = l[v];
                        A = 1 - p;
                        h[0][v] = A * A * A * t + 3 * A * A * p * i + 3 * A * p * p * n + p * p *
                            p * r;
                        h[1][v] = A * A * A * e + 3 * A * A * p * s + 3 * A * p * p * a + p * p *
                            p * o
                    }
                    h[0][y] = t;
                    h[1][y] = e;
                    ...
                    return [Math.min(...h[0]), Math.min(...h[1]), Math.max(...h[0]), Math.max(...h[
                        1])]
                }
            }
...
t = "function" == typeof Symbol ? Symbol("webpack queues") : "__webpack_queues__", e = "function" ==
typeof Symbol ? Symbol("webpack exports") : "__webpack_exports__", i = "function" == typeof Symbol ?
Symbol("webpack error") : "__webpack_error__", s = t => {
    if (t && t.d < 1) {
        t.d = 1;
        t.forEach((t => t.r--));
    ...
    a((n => {
        ...
        var a, getResult = () => l.map((t => {
            ...
            r = new Promise((e => {
                (a = () => e(getResult)).r = 0;
                var fnQueue = t => t !== o && !c.has(t) && (c.add(t), t && !t.d && (
                    a.r++, t.push(a)));
                l.map((e => e[t](fnQueue)))
            }));
...
for (var i in e) __webpack_require__.o(e, i) && !__webpack_require__.o(t, i) && Object
    .defineProperty(t, i, {
        enumerable: !0,
        get: e[i]
    })
...
X = r.version;
export {
o as AbortException, l as AnnotationEditorLayer, h as AnnotationEditorParamsType,
d as AnnotationEditorType, c as AnnotationEditorUIManager, u as AnnotationLayer, p as AnnotationMode,
g as CMapCompressionType, m as DOMSVGFactory, f as FeatureTest, b as GlobalWorkerOptions,
A as ImageKind, v as InvalidPDFException, y as MissingPDFException, _ as OPS,
E as PDFDataRangeTransport, x as PDFDateString, w as PDFWorker, S as PasswordResponses,
C as PermissionFlag, T as PixelsPerInch, M as PromiseCapability, R as RenderingCancelledException,
F as UnexpectedResponseException, P as Util, k as VerbosityLevel, D as XfaLayer, I as build,
L as createValidAbsoluteUrl, O as getDocument, B as getFilenameFromUrl, N as getPdfFilenameFromUrl,
U as getXfaPageViewport, z as isDataScheme, H as isPdfFile, j as noContextMenu, V as normalizeUnicode,
W as renderTextLayer, q as setLayerDimensions, G as shadow, $ as updateTextLayer, X as version
};